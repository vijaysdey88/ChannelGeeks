...
angular.module("core").config(["$locationProvider","$compileProvider",function(a,d){a.html5Mode(!1);a.hashPrefix("!");d.aHrefSanitizationWhitelist(/^\s*(https?|mailto|blob):/)}]).run(["dateTime","secondsSinceEpoch",function(a,d){a.initialize(1E3*d)}]);angular.module("page.account",["ngRoute","core","account"]);
...
{stripe_token:a})}).then(function(b){a.creditCardErrorMessage="";a.customer=b;a.customerCard=c.getDefaultCard(b);a.editingCreditCard=!1;a.enabledCreditCardButton=!0},function(b){a.creditCardErrorMessage=c.prettifyErrorResponse(b);a.enabledCreditCardButton=!0}))};d()}]);angular.module("account").factory("cancellationFlow",["modal","$q","api","$location","customers","CancellationFrame","products","recordActivity","dateTime","currentUser","$rootScope","$window",function(a,d,b,c,e,f,g,h,i,j,k,l){var m=j.fetchFullUser();return{cancelSubscription:function(c){var e=c.id,d=c.status,h=1E3*(c.trial_end||c.start),j=1E3*c.current_period_end,k=(Math.random().toString(36)+"000000000000000").slice(2,16),u=c.plan.id;"trialing"!==d&&i.calculateDaysBetweenDates(new Date(h),i.getCurrent());
f.setFlowToken(k);f.sendCancellationActivity("start");return m.then(function(){return g.get(u).then(function(a){try{return f.setCourseKey(a._course_groups[0].course_ref.key),b.get("/users/node_progress/"+f.getCourseKey()).then(function(a){f.setCompletionStats(a.data.stats);return a.data.stats})}catch(c){return f.setCourseKey("ndXXX")}})}).then(function(){return a.activate("postCancelSurvey",{subscriptionId:e,subscriptionPlanId:u,subscriptionPeriodEndDate:new Date(j)}).then(function(){l.location.reload()}).catch(function(){f.sendCancellationActivity("abort").then(function(){f.setCurrentFrame("cancelSurvey")})})},
function(){l.location.reload()})}}}]);angular.module("account").factory("CancellationFrame",["recordActivity",function(a){var d="cancelSurvey",b="",c="",e={time:0,projects:0,quizzes:0},f=function(){switch(d){case "cancelSurvey":return 1;case "accomplishments":return 2;case "hereToHelp":return 3;case "startAConvo":return 4;case "rogerThat":return 5;case "reminder":return 6;case "cancelled":return 7}},g=function(){var a=c.slice(0,2);return"ca"===a?"Career":"nd"===a?"Degree":"Course"};return{getCurrentStep:f,getCurrentFrame:function(){return d},
setCurrentFrame:function(a){return d=a},getFlowToken:function(){return b},setFlowToken:function(a){return b=a},getCourseKey:function(){return c},setCourseKey:function(a){return c=a},getCourseType:g,sendCancellationActivity:function(e,d,j,k){var l=b,d=d||f(),m=c,n=g(),p,q;j&&(p=j);k&&(q=k);return a.cancellationFlowStep(l,d,m,n,e,p,q)},getCompletionStats:function(){return e},setCompletionStats:function(a){e={time:Math.round(a.time/60),projects:a.projects,quizzes:a.quizzes}},sufficientTimeInClass:function(){return 30<=
e.time}}}]);angular.module("account").controller("contactInfoTab",["$scope","country","currentUser","users","validator","$window",function(a,d,b,c,e,f){a.saveDisabled=!1;a.showForm=!1;a.serverSuccess="";a.serverError="";a.countries=[""].concat(d.countries);a.contactInfoErrors={};b.fetchFullUser().then(function(b){a.user=b;a.user.mailing_address||(a.user.mailing_address={address_line_1:"",address_line_2:"",city:"",region:"",postal_code:"",country:""});a.showForm=!0});a.saveContactInfo=function(){if(!a.saveDisabled){a.saveDisabled=
...
function(b){a.serverError=b.error;a.saveDisabled=!1}):a.saveDisabled=!1}}}]);angular.module("account").controller("developmentEnvironmentInfoTab",["$scope","currentUser","developmentEnvironments","$log",function(a,d){a.accountKey=d.get("key")}]);angular.module("account").controller("linkedAccountsTab",["$scope","$timeout","currentUser","users","google","facebook","normalizedSocialService","session","siteExperience",function(a,d,b,c,e,f,g,h,i){a.loading=!0;a.managed=i.managedAccount;a.accounts={google:null,facebook:null};var j=function(){a.serverSuccess="";a.serverError=""},k=function(b,c,e){c=g.normalizeAccount(b,c);c.id===a.user["_"+b+"_id"]||e?c.loggedIn=!0:c={loggedIn:!1};return a.accounts[b]=c},l=function(b){a.loading=!1;a.serverError=
b.error};a.getLinkedAccountTypes=function(){return _.keys(a.accounts)};a.disconnect=function(b){a.loading=!0;var e={key:a.user.key};e[b+"_id"]=null;c.put(e).then(function(c){j();a.loading=!1;a.user=c;"github"!==b&&(a.accounts[b]=null)},l)};a.disconnectSocial=function(b){a.loading=!0;var e={key:a.user.key},d=a.user.social_accounts.length&&"github"==b?"social_accounts":"external_accounts",f=null;_.each(a.user[d],function(a,c){if(a.account_type===b||a.affiliate_program_key===b)f=c});null==f?a.loading=
!1:(a.user[d].splice(f,1),e[d]=a.user[d],c.put(e).then(function(c){j();a.loading=!1;a.user=c;a[b]=null},l))};a.connect=function(b){a.loading=!0;var e=g.normalizeAccountService(b),f=function(g,h){var i=function(a){401===a.code&&f(g-1,3*h)};0===g&&(i=l);d(function(){e.getAccount().then(function(e){var d={key:a.user.key};d[b+"_id"]=e.id;c.put(d).then(function(c){e=k(b,e,!0);j();a.loading=!1;a.user=c},l)},i)},h)},i=function(){f(3,500)};e.login().then(function(a){a=g.createSessionData(b,a);h.put(a).then(i,
i)},l)};j();b.fetchFullUser().then(function(){a.loading=!1;a.user=b.getUser();_.each(a.user.social_accounts,function(b){a[b.affiliate_program_key]=b});_.each(a.user.external_accounts,function(b){a[b.affiliate_program_key]=b});_.each(a.getLinkedAccountTypes(),function(a){g.normalizeAccountService(a).getAccount().then(function(b){k(a,b)})})},l)}]);angular.module("account").controller("myCertificatesTab",["$q","$scope","$sce","currentUser","users","nodes",function(a,d,b,c,e,f){d.loading=!0;d.verifiedCertificates=[];d.nodeMap={};d.serverError="";var g=c.getUser();d.getBadges=function(){return _.filter(g._badges,function(a){return"Course Mastery"===a.name&&0<a.highest_level})};a.all([e.getCertificates("me").then(function(a){d.verifiedCertificates=a;a=_.map(a,function(a){return a.node_ref.key});return f.batchGet(a,{projection:"catalog"}).then(function(a){_.extend(d.nodeMap,
...
function(){d.cancel()};a.keepLearning=function(){a.closeModal();g.location.href="/me"};a.confirmModal=function(){d.confirm()};a.startConversation=function(){m.sendCancellationActivity("startChat",4,a.survey.code,a.survey.comment);return c.post("/email/send_cancellation_reason",{email_problem:a.survey.reason,email_comment:a.survey.comment,node_id:m.getCourseKey()}).then(function(a){return a.data})}}]);angular.module("utility").service("showChat",["currentUser","$q",function(a,d){var b=null;return{getGroupChatPromise:function(){b||(b=d.defer(),a.fetchFullUser().then(function(c){a.isStaff()?b.resolve(!0):a.fetchEnrolledAndGraduatedNanodegreeKeys().then(function(a){if(1===a.length&&"nd801"===a[0])b.resolve(!1);else{var d=_.filter(c._enrollments,function(b){return _.contains(a,b.node_key)});_.find(d,function(a){if(a.first_paid_enrollment_time)return new Date(a.first_paid_enrollment_time)>new Date(2015,
6,5)})?b.resolve(!1):b.resolve(0<_.size(a))}})}));return b.promise}}}]);angular.module("widgets").directive("tutoringWhiteboard",["$http",function(a){return{restrict:"A",link:function(d,b){d.showWhiteboard=!1;d.showWhiteboardHolder=!1;d.toggleWhiteboard=function(){d.showWhiteboard=!d.showWhiteboard};var c=b.find(".tutoring-whiteboard-frame-holder");window.olark("api.chat.onCommandFromOperator",function(b){"whiteboard"===b.command.name&&(window.olark("api.chat.sendNotificationToOperator",{body:"Creating whiteboard..."}),c.children().length&&c.empty(),a.get("/api/session/whiteboard?title=Whiteboard").then(function(a){d.showWhiteboardHolder=
...
isFreeEnrolled:function(a,c){return!d.isCurrentEnrolled(a,c)&&"enrolled"===a.state},hasEnrolled:function(b,c){return a(b,c,"past_student_group_refs")||d.isGraduated(b,c)},hasPermissionTo:function(a,c){return a&&!!_.find(a.guard.allowed_behaviors,function(a){return a===c})}};return d}]);angular.module("foundation").directive("notificationsDropdown",["notificationsDropdownHelper","layer","$q","currentUser","$timeout","$window","nodes","cacheVersion",function(a,d,b,c,e,f,g,h){return{scope:{},restrict:"A",templateUrl:"/templates/notifications_dropdown/notifications_dropdown.html?"+h,link:function(b){var h;d.authenticate().then(function(){h=d.startWebSocketConnection();return c.fetchStudyGroups()}).then(function(c){b.showNotifications=c&&0<c.length;if(b.showNotifications){b.loading=
!0;b.nodeMap=null;b.hasSeenAllNotifications=!1;b.markNotificationsAsRead=function(){b.hasSeenAllNotifications=!0};b.hasUnreadNotification=function(){return _.some(b.nodeMap,function(a){return a.conversation&&0<a.conversation.unread_message_count})};var d=_.flatten(_.map(c,function(a){return _.map(a._node_refs,function(a){return a.key})}));b.openTeamsPage=function(a){a=b.goToTeamsPage(a);f.open(a,"_blank")};b.goToTeamsPage=function(a){return a?"/teams/#/chat/"+a:"/teams/#/chat/"+d[0]};var m=_.indexBy(c,
"conversation_id");g.batchGet(d).then(function(d){b.nodeMap=d;a.updateNodeMapWithExistingConversations(b.nodeMap,c).then(function(){e(function(){})});b.loading=!1;var f=0;h.onmessage=function(c){c=JSON.parse(c.data);a.isUnreadMessageCountPacket(c)&&(a.updateUnreadMessageCountInNodeMap(b.nodeMap,m,c),b.hasSeenAllNotifications&&(c=a.calculateTotalUnreadMessageCountInNodeMap(b.nodeMap),c>f&&(b.hasSeenAllNotifications=!1),f=c),e(function(){}))}})}})}}}]).service("notificationsDropdownHelper",["layer",
"$q",function(a,d){return{isUnreadMessageCountPacket:function(a){return a.object&&"Conversation"===a.object.type&&"change"===a.type?_.some(a.data,function(a){return"unread_message_count"===a.property}):!1},updateNodeMapWithExistingConversations:function(b,c){return d.all(_.map(c,function(c){return a.fetchConversation(c.conversation_id).then(function(a){b[c._node_refs[0].key].conversation=a}).catch(function(){})}))},updateUnreadMessageCountInNodeMap:function(a,c,e){if(c=c[e.object.id]){var d=a[c._node_refs[0].key];
d&&(d.conversation=d.conversation||{},_.forEach(e.data,function(a){"unread_message_count"===a.property&&(d.conversation.unread_message_count=a.value)}))}return a},calculateTotalUnreadMessageCountInNodeMap:function(a){return _.reduce(a,function(a,b){return b.conversation&&b.conversation.unread_message_count?a+b.conversation.unread_message_count:a},0)}}}]).service("layer",["$http","$timeout","$q","applicationEnvironment","users",function(a,d,b,c,e){var f={};f.layerAppId=c.isInDevelopment()?"e5fe3bb6-1ef1-11e5-9078-ad56000000fb":
"e5fe4034-1ef1-11e5-8bd1-ad56000000fb";f.fetchConversation=function(a){return f.layerGet(f.getUrlFromLayerId(a)).then(function(a){return a.data})};f.getUrlFromLayerId=function(a){return a.split("layer://")[1]};f.layerGet=function(b,c,e){return a.get("https://udacity-api.layer.com"+b,_.extend({data:c},{headers:f.addLayerHeaders(_.extend(a.defaults.headers.common,e))}))};f.layerPost=function(b,c){return a.post("https://udacity-api.layer.com"+b,c,{headers:f.addLayerHeaders(a.defaults.headers.common)})};
f.addLayerHeaders=function(a){return _.extend({},a||{},{Authorization:f.sessionToken?'Layer session-token="'+f.sessionToken+'"':void 0,"X-Udacity-Client":void 0,Accept:"application/vnd.layer+json; version=1.0"})};f.generateNonce=function(){return f.layerPost("/nonces").then(function(a){return a.data.nonce})};var g=null;f.authenticate=function(){return g=g||f.generateNonce().then(function(a){return f.requestAuthenticationNonceWithCompletion(a)}).then(function(a){f.sessionToken=a})};f.startWebSocketConnection=
function(){return new WebSocket("wss://udacity-api.layer.com/websocket?session_token="+f.sessionToken,"com.layer.notifications-1.0")};f.requestAuthenticationNonceWithCompletion=function(a){return e.fetchJWTForLayer(a).then(function(a){return f.layerPost("/sessions",{identity_token:a,app_id:f.layerAppId})}).then(function(a){return a.data.session_token})};return f}]);angular.module("foundation").controller("siteFrame",["$scope","$window","localStorage",function(a,d,b){a.responsivenessIsEnabled=!1;a.$on("setResponsiveness",function(b,e){!a.responsivenessIsEnabled&&e&&0===$('meta[name="viewport"]').length?$("head").append('<meta name="viewport" content="width=device-width, initial-scale=1.0" />'):$('meta[name="viewport"]').remove();a.responsivenessIsEnabled=e});a.cacheBustingIsEnabled="yes"===b.getItem("bustAllTheCaches")?"yes":"no";a.toggleCacheBusting=function(){a.cacheBustingIsEnabled=
...
"AffiliateContactDetails";return a.post(b,c).then(function(a){return a.data.profile})}};return d}]);angular.module("gateways").provider("api",[function(){var a=function(a){return _.reduce(_.keys(a).sort(),function(b,c){var e=a[c];angular.isArray(e)&&(c+="[]");b[c]=e;return b},{})},d=function(){return Date.now()||+new Date},b={init:function(a,b){a.configuration=b;b.baseUrl=_.isUndefined(b.baseUrl)?"":b.baseUrl;a.setBaseUrl=function(a){b.baseUrl=/\/$/.test(a)?a.substring(0,a.length-1):a;return this}}},c={baseUrl:"/api"},e=null;b.init(this,c);this.$get=["$http","mixin","$window","gitRevision","universalAnalytics",
"localStorage",function(f,g,h,i,j,k){var l=["sessionExpired"];f.defaults.headers.common["X-Udacity-Client"]="udacity.com; version="+i;var m=function(c){var i={get:function(b,e,g){g=g||{};"yes"===k.getItem("bustAllTheCaches")&&(e=e||{},e.cacheBusterValue=Math.random());g.params=a(e);g.cache=!0;var h=i.buildGetUrl(b,e),j=d();return 1600<h.length?(g.lengthy||console.warn("Url potentially too large for GET request; switching to POST. Set configuration option lengthy=true to suppress this warning."),delete g.params,
b+=(-1===b.indexOf("?")?"?":"&")+"_method=GET",i.verifySession(i.timeRequest(f.post(c.baseUrl+b,e,g),j))):i.verifySession(i.timeRequest(f.get(c.baseUrl+b,g),j))},post:function(a,b,e){var g=d();return i.verifySession(i.timeRequest(f.post(c.baseUrl+a,b,e),g))},deleteRequest:function(a,b,e){e=e||{};e.params=b;b=d();return i.verifySession(i.timeRequest(f["delete"](c.baseUrl+a,e),b))},timeRequest:function(a,b){return a.success(function(a,c,e){a=e("X-Udacity-Trail");c=d()-b;e=h.location.pathname+h.location.hash;
0<=c&&36E5>c&&j.trackTiming({"var":a||"unknown",category:"request",label:e,value:c})})},getCurrentUserKey:function(){return e=e||f({method:"GET",cache:!0,url:"/api/session"}).then(function(a){return a.data.account.key})},verifySession:function(a){return a.success(function(a,b,c){i.getCurrentUserKey().then(function(a){var b=c("X-Udacity-Account-Id");b&&b!==a&&i.emitEvent("sessionExpired",{accountId:a})})}).error(function(a,b,c){i.getCurrentUserKey().then(function(a){var e=c("X-Udacity-Account-Id");
(401===b||e&&e!==a)&&i.emitEvent("sessionExpired",{accountId:a})})})},buildGetUrl:function(b,c){var e;e="/api"+b;var d=a(c),d=_.reduce(d,function(a,b,c){b&&null!==b&&(angular.isArray(b)||(b=[b]),b=_.map(b,function(a){angular.isObject(a)&&(a=JSON.stringify(a));return i._encodeUriQuery(c)+"="+i._encodeUriQuery(a)}),a=a.concat(b));return a},[]);e=0===d.length?e:e+(-1===e.indexOf("?")?"?":"&")+d.join("&");return e},_encodeUriQuery:function(a,b){return encodeURIComponent(a).replace(/%40/gi,"@").replace(/%3A/gi,
":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,b?"%20":"+")}};b.init(i,c);i=g.eventEmission(i,l);i.withConfig=_.bind(function(a){var e=angular.copy(_.omit(c,"configuration"));b.init(e,e);a(e);return m(e)},i);return i};return m(c)}]}]);angular.module("gateways").factory("cohortsGateway",["api",function(a){return{get:function(d,b){return a.get("/cohorts/"+encodeURIComponent(d),b).then(function(a){return a.data.cohort})},remove:function(d){return a.deleteRequest("/cohorts/"+encodeURIComponent(d)).then(function(a){return a.data})},searchCohorts:function(d){return a.get("/cohorts",d).then(function(a){return a.data.cohorts})},put:function(d){return a.post("/cohorts",{cohorts:d}).then(function(a){return a.data.cohort})}}}]);angular.module("gateways").factory("coupons",["api","$timeout","$q",function(a){return{get:function(d){return a.get("/coupons/"+d).then(function(a){return a.data.coupon})},put:function(d){return a.post("/coupons",d).then(function(a){return a.data.coupon})},list:function(d){var b=_.omit(d,"offset","limit");b.paging={offset:d&&d.offset||0,limit:d&&d.limit||60};return a.get("/coupons",b).then(function(a){return a.data})},computeDiscount:function(d,b){return a.get("/coupons/"+d+"/compute_discount",{product_key:b}).then(function(a){return a.data})}}}]);angular.module("gateways").factory("customers",["api",function(a){return{get:function(d,b){return a.get("/customers/"+encodeURIComponent(d),b).then(function(a){return a.data.customer})},put:function(d,b){return a.post("/customers/"+encodeURIComponent(d),b).then(function(a){return a.data.customer})},removeSubscription:function(d,b){return a.deleteRequest("/customers/"+encodeURIComponent(d)+"/subscriptions/"+encodeURIComponent(b)).then(function(a){return a.data})},removeCreditCard:function(d,b){return a.deleteRequest("/customers/"+
...
return a.post("/users/"+encodeURIComponent(b)+"/memberships",c).then(function(a){return a.data.group_refs_left})}}}]);angular.module("gateways").factory("nodeStates",["api",function(a){var d={get:function(a,c,e){return d.batchGet(a,[c],e).then(function(a){return a[c]})},batchGet:function(b,c,d){d=angular.copy(d)||{};d.node_keys=c;d.user_key=b;return a.get("/nodes/state",d).then(function(a){var b={};_.each(a.data.nodestates,function(a){b[a.node_ref.key]=a});return b})}};return d}]);angular.module("gateways").factory("nodeTests",["$q","api",function(a,d){return{batchGet:function(a){return d.get("/node_tests",{node_key:a}).then(function(a){return a.data.node_tests})},put:function(a){return d.post("/node_tests",{node_tests:[a]}).then(function(a){var a=a.data.references.NodeFunctionalTest,b=_.keys(a)[0];return a[b]})},deleteTest:function(a){return d.deleteRequest("/node_tests/"+encodeURIComponent(a)).then(function(a){return a.data})}}}]);angular.module("gateways").factory("nodes",["$log","api","entityStore",function(a,d,b){var c={get:function(a,b){return c.batchGet([a],b).then(function(b){return b[a]})},batchGet:function(a,b){b=angular.copy(b)||{};b.keys=a;return d.get("/nodes",b).then(function(a){a.data.references.Node&&$.each(a.data.references.Node,function(a,b){b.getCourseType=function(){return"ca"===b.key.slice(0,2)?"Career":b._semantic_type};b.isNanodegree=function(){return"Degree"===this.getCourseType()};b.isCareer=function(){return"Career"===
this.getCourseType()}});return a.data.references.Node||{}})},put:function(a,b){return c.batchPut([a],b).then(function(b){return a.key?b[a.key]:b[_.first(_.keys(b))]})},batchPut:function(a,b){b=angular.copy(b)||{};b.nodes=a;return d.post("/nodes",b).then(function(a){return a.data.references.Node})},list:function(){throw Error("Not supported by the API");},state:function(a,b,d){return c.batchState([a],b,d).then(function(a){return _.first(a)})},batchState:function(a,b,c){c=angular.copy(c)||{};c.node_keys=
a;c.user_key=b;return d.get("/nodes/state",c).then(function(a){return a.data.nodestates})},getRevision:function(a,b){return d.get("/nodes/"+encodeURIComponent(a)+"/revisions"+encodeURIComponent(b)).then(function(a){return a.data.node})},listRevisions:function(a,b){var c=_.omit(b,"offset","limit","cursor_map");c.paging={cursor_map:b&&b.cursor_map||null,offset:b&&b.offset||0,limit:b&&b.limit||10};return d.get("/nodes/"+encodeURIComponent(a)+"/revisions",c).then(function(a){return a.data.revisions})},
examify:function(a){return d.post("/nodes/"+encodeURIComponent(a)+"/exam").then(function(a){return a.data})},deExamify:function(a){return d.deleteRequest("/nodes/"+encodeURIComponent(a)+"/exam").then(function(a){return a.data})},getPotentialTutorKeys:function(a,b){return d.get("/nodes/"+encodeURIComponent(a)+"/tutors",b).then(function(a){return a.data})},addPotentialTutor:function(a,b){return d.post("/nodes/"+encodeURIComponent(a)+"/tutors",{tutor_key:b})},removePotentialTutor:function(a,b){return d.deleteRequest("/nodes/"+
encodeURIComponent(a)+"/tutors",{tutor_key:b})},getForumPosts:function(b,c,g){return d.get("/nodes/"+encodeURIComponent(b)+"/forum_posts").then(function(b){try{var d=JSON.parse(b.data.posts);return _.first(_.map(d,function(a){return{title:a.title,href:a.href+"#"+c.key,date:a.date,score:a.score,answer_count:a.answer_count,views:a.views,important:a.important}}),g)}catch(e){return a.error(e),[]}})}};b.setProjections("Node",{navigation:{supers:[],base:!0},synopsis:{supers:[],base:!0},classroom:{supers:[],
base:!0},catalog:{supers:[],base:!0}});return b.standardMixin("Node",c)}]);angular.module("gateways").factory("products",["api",function(a){var d={get:function(b,c){return a.get("/products/"+b,c).then(function(a){return a.data.product})},batchGet:function(){throw Error("Not Implimented in API!");},put:function(a,c){return d.batchPut([a],c).then(function(c){return a.key?c[a.key]:_.first(_.values(c))})},batchPut:function(b,c){return a.post("/products",_.extend({products:b},c)).then(function(a){return a.data.references.Product})},list:function(b){var c=_.omit(b,"offset","limit",
...
encodeURIComponent(a)).then(function(a){if(a=a.data.user._memberships)return 0<_.filter(a,function(a){return-1<a.group_ref.key.indexOf("staff")}).length})},checkIfFirstChatVisit:function(a){return d.get("/users/"+a+"/tags",{namespace:"chat",tag:"introtochatseen"})},setFirstChatVisit:function(a){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"chat",tag:"introtochatseen"}]})},checkNewHomeBanner:function(a){return d.get("/users/"+a+"/tags",{namespace:"showNotificationBanner",
tag:"hidden"})},setNewHomeBanner:function(a){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"showNotificationBanner",tag:"hidden"}]})},setAddToCalFlag:function(a,c){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"showAddToCalBanner",tag:c}]})},setOnboardingFlag:function(a,c){return d.post("/users/"+a+"/tags",{tags_to_add:[{model:"Tag",namespace:"ndonboarding",tag:c}]})},getTags:function(){return d.get("/users/me/tags")},getStudyGroups:function(a){return d.get("/study_groups/get_for_user/"+
a).then(function(a){return a.data.groups})},fetchJWTForLayer:function(a){return d.post("/session/chat/jwt",{nonce:a}).then(function(a){return a.data.identity_token})},addToEmailList:function(a,c,e,f){a={email_address:c,user_name:a,list_name:e};f&&(a.data=f);return d.post("/users/join_email_list",a)},getSignatureUploadUrl:function(a){return d.get("/users/"+encodeURIComponent(a)+"/signature/upload_url").then(function(a){return a.data.url})},getImageUploadUrl:function(a){return d.get("/users/"+encodeURIComponent(a)+
"/image/upload_url").then(function(a){return a.data.url})},getTutors:function(a,c){return d.get("/users/"+encodeURIComponent(a)+"/tutors",c).then(function(a){return a.data})},getTutees:function(a,c){return d.get("/users/"+encodeURIComponent(a)+"/tutees",c).then(function(a){return a.data})},setTutor:function(a,c,e){return d.post("/users/"+encodeURIComponent(a)+"/enrollments/"+encodeURIComponent(c)+"/tutor",{tutor_account_key:e}).then(function(a){return a.data})},removeTutor:function(a,c,e){return d.deleteRequest("/users/"+
encodeURIComponent(a)+"/enrollments/"+encodeURIComponent(c)+"/tutor",{tutor_account_key:e}).then(function(a){return a.data})}}}]);angular.module("embedded").constant("tags",{collection:"k-",course:"c-",lesson:"l-",exercise:"e-",morsel:"m-",tidbit:"t-"}).constant("typeForTag",{"k-":"collection","c-":"course","l-":"lesson","e-":"exercise","m-":"morsel","t-":"tidbit"});angular.module("utility").directive("qualarooSurveyInfoHack",["qualarooSurveyor","dateTime","currentUser","cookieJar","qualaroo",function(a,d,b,c,e){return{link:function(){if(b.userIsLoggedIn()){var c=d.getCurrent(),g=new Date(c.setDate(c.getDate()-21));a.fetchEarliestPaidEnrollmentDate(b.getUser()).then(function(c){e.set({paid:c?"yes":"no"});e.set({subscribed_over_three_weeks:c&&c<g?"yes":"no"});e.set({gt:a.everEnrolledInGtCourses(b.getUser())?"yes":"no"})})}}}}]);angular.module("utility").factory("qualarooSurveyor",["dateTime","$q","nodeUtility","nodes",function(a,d,b,c){var e={fetchEarliestPaidEnrollmentDate:function(a){var g=_.without(_.filter(a._enrollments,function(a){return a.first_paid_enrollment_time},null,void 0));return g.length?c.batchGet(_.pluck(g,"node_key")).then(function(a){var c=_.filter(g,function(c){return _.any(a,function(a){return b.isCurrentEnrolled(c,a)})}),c=_.map(c,function(a){return e._convertIsoDateToYearMonthDayDate(a.first_paid_enrollment_time)});
return c.length?_.min(c):null}):d.when(!1)},_convertIsoDateToYearMonthDayDate:function(a){if(a)return a=a.substring(0,10).split("-"),a=_.map(a,function(a){return parseInt(a,10)}),new Date(a[0],a[1]-1,a[2])},everEnrolledInGtCourses:function(a){return _.any(a._enrollments,function(a){return _.any(a.group_refs,function(a){return a.key&&0===a.key.toLowerCase().indexOf("gt")})})}};return e}]);angular.module("overview").directive("careerEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","cookieJar","googleTagManager","universalAnalytics",function(a,d,b,c,e,f,g,h,i){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/career_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){var b=function(){h.pushTrackingEvent("careerAccess");f.location.href="/me"};a.getCareerButtonInfo=function(){return a.isAccessible&&
(a.isPaidEnrolled||a.isPaidGraduated)?{variant:"program is live, student is enrolled or graduated",text:"Continue program",action:b}:a.isPaidEnrollable?a.isClassFull?a.isPaidWaitlisted?(g.exists("udacity_notify_me_clicked_recently")&&(h.pushTrackingEvent("notificationListJoin"),i.trackEvent({category:"Waitlist",action:"SignUp",label:a.courseKey}),g.remove("udacity_notify_me_clicked_recently")),{variant:"program is full, student is waitlisted",statusSuccess:!0}):{variant:"program is full, student not waitlisted, not enrolled",
text:"Notify me",sidenote:"when program re-opens",action:function(){g.set("udacity_notify_me_clicked_recently","yes",{expires:new Date((new Date).getTime()+6E5)});a._joinGroup(a.waitlistGroupKey)}}:{variant:"program live, student not enrolled",text:"Enroll in Program",sidenote:"After 1 week free trial",action:function(){h.pushTrackingEvent("careerEnrollment");a._purchaseCourse()}}:{variant:"program not open for paid enrollment",sidenote:"This program is not yet available for enrollment"}};a=_.extend(a,
a.enrollmentActions);a.productLaunchDate=new Date(a.productLaunchDateString);a.hasProductLaunched=a.enrollmentActions.isLaunched;a.isVIP=a.isAccessible&&(!a.isAvailable&&!a.isLaunched||a.canEditContent)&&a.getCareerButtonInfo().action!==b;a.isFull=a.isClassFull&&!(a.isPaidInterested||a.isPaidEnrolled||a.isPaidGraduated)}}}]);angular.module("courseCatalog").config(["$locationProvider",function(a){a.html5Mode(!0).hashPrefix("!")}]).constant("SEARCH_DEBOUNCE_MILLIS",5E3).controller("courseCatalog",["$scope","$location","$timeout","$filter","$q","affiliates","courseCatalogHelper","publicCatalog","SEARCH_DEBOUNCE_MILLIS","universalAnalytics",function(a,d,b,c,e,f,g,h,i,j){var k=_.debounce(function(a,b,c){j.trackEvent({category:a,action:b,label:c})},i);a.fullTextSearch={query:""};a.filterCourses=function(b){var e=_.object(_.map(a.filters,
function(a,b){return[b,_.reduce(a.options,function(a,b){return b.selected?a.concat(b):a},[])]})),f=_.filter(b,function(b){return a.activeCategory&&_.any(a.activeCategory.all_children,function(a){return a&&a===b.key})&&_.every(a.filters,function(a,c){return!e[c].length||a.match(b,e[c])})});if(a.fullTextSearch.query){var g=$.trim(a.fullTextSearch.query).toLowerCase();k("Catalog","Search",g);f=c("filter")(f,a.fullTextSearch.query)}!f.length&&a.activeCategory?(f=_.filter(b,function(b){return _.any(a.activeCategory.courses,
function(a){return a&&a===b.key})}),a.fallback=!0):a.fallback=!1;b=_.sortBy(_.filter(a.filters,function(a){return a.exposeInAddressAs}),"id");_.each(b,function(a){var b=_.sortBy(_.pluck(_.where(a.options,{selected:!0}),"name"),_.identity);d.search(a.exposeInAddressAs,b)});return f};var l=null;a.getSelectedTechnologyNames=function(){l||(l=_.findWhere(a.filters,{id:"technologyKeywords"}));return _.map(_.pluck(_.where(l&&l.options,{selected:!0}),"name"),c("titleCase"))};a.getPageDescription=function(){var b=
a.getSelectedTechnologyNames(),c="",d=a.activeCategory&&a.activeCategory.name;1===b.length?c=_.first(b)+" ":1<b.length&&(c=_.initial(b).join(", ")+", and "+_.last(b)+" ");return"Browse "+d+" Course and Nanodegree Programs to help advance your career. You'll learn "+c+"from industry experts from Google, Facebook, Twitter and Cloudera."};h.list().then(function(b){var c=function(a){return"ud853ar"!=a.key&&"ud000"!=a.key};b.degrees=_.filter(b.degrees,c);b.courses=_.filter(b.courses,c);a.courses=_.map(_.union(b.degrees,
b.courses),function(a){a.affiliates.length&&(a.affiliate_program_refs=_.map(a.affiliates,function(a){return{key:a.key}}));return a});a.affiliateMap=_.reduce(a.courses,function(a,b){b.affiliates.length&&_.each(b.affiliates,function(b){a[b.key]=b});return a},{});a.tracks=b.tracks;return{courses:a.courses,affiliates:a.affiliateMap,tracks:a.tracks}}).then(function(b){a.filters=g.initializeFilters(b.courses,b.affiliates,d.search());d.search("");var e=function(){var e=_.find(b.tracks,function(a){return c("slugify")(a.name)===
d.path().substr(1)});e?a.activeCategory=e:d.path("all")};a.$on("$locationChangeSuccess",e);e();a.loadingComplete=!0})}]);angular.module("courseCatalog").constant("AFFILIATE_PRIORITIES",{facebook:1E3,google:1E3,Salesforce:1E3,gt:8E3,sjsu:8E3,twentythree:9E3}).factory("courseCatalogHelper",["AFFILIATE_PRIORITIES",function(a){var d="ma004 ma006 ma008 bio110 ph100 ps001".split(" "),b=[{id:"skills",name:"Skill Level",makeTitleCase:!0,generateOptions:function(a,b,d){return _.map(_.sortBy(_.unique(_.map(a,function(a){return a.level})).concat("new to tech"),function(a){return{beginner:1,intermediate:2,advanced:3}[a]||0}),function(a){return{name:a,
...
function(a){return a[1].last_interaction_time}).reverse()[0][0]);b=c}else b=null;a.lastInteractedLessonKey=b}),i.getCertificates("me").then(function(a){k=a;_.each(k,function(a){var b=a.node_ref.key;_.has(l,b)?l[b].last_modification_time<a.last_modification_time&&(l[b]=a):l[b]=a})})]).then(function(){a.loading=!1;a.premiumAccess=h.hasPermissionTo(a.course,"view-paid-supplemental-media")||h.isCurrentEnrolled(a.enrollment,a.course)||h.isGraduated(a.enrollment,a.course)})});a.getCompletedLessonKeys=function(a){return a?
_.unique(_.pluck(a.completed_descendant_node_refs,"key")):[]};a.isComplete=function(b,c){return _.contains(a.getCompletedLessonKeys(c),b)};a.isPartiallyComplete=function(a,b){return b&&b.progress&&b.progress[a]?0<b.progress[a].completed_morsel_count:!1};a.getCertificate=function(a){return l[a]};a.isCurrentEnrolled=h.isCurrentEnrolled;a.isGraduated=h.isGraduated;a.managedAccount=j.managedAccount;a.getCourseType=function(){var b=a.courseKey.slice(0,2);return"ca"===b?"Career":"nd"===b?"Degree":"Course"};
...
"Group"===a.group_ref.ref&&e(a.group_ref.key)});a.ready=!0})}]);angular.module("overview").directive("nanodegreeEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","cookieJar","googleTagManager","universalAnalytics",function(a,d,b,c,e,f,g,h,i){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/nanodegree_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){var b=function(a){return{nd000:{start:"August 11 at 12:00 pm Eastern Time",end:"August 23 at 11:59 pm Eastern Time"},
nd001:{start:"August 11 at 12:00 pm Eastern Time",end:"August 23 at 11:59 pm Eastern Time"},nd002:{start:"August 11 at 12:00 pm Eastern Time",end:"August 23 at 11:59 pm Eastern Time"},nd003:{start:"August 11 at 12:00 pm Eastern Time",end:"August 23 at 11:59 pm Eastern Time"},nd004:{start:"August 11 at 12:00 pm Eastern Time",end:"August 23 at 11:59 pm Eastern Time"},nd801:{start:"August 11 at 12:00 pm Eastern Time",end:"August 23 at 11:59 pm Eastern Time"}}[a]||{}},c=function(){h.pushTrackingEvent("nanodegreeAccess");
f.location.href="/me"};a.getNanodegreeButtonInfo=function(){return a.isAccessible&&(a.isPaidEnrolled||a.isPaidGraduated)?{variant:"nanodegree is live, student is enrolled or graduated",text:"Continue Nanodegree",action:c}:a.isPaidEnrollable?a.isClassFull?a.isPaidWaitlisted?(g.exists("udacity_notify_me_clicked_recently")&&(h.pushTrackingEvent("notificationListJoin"),i.trackEvent({category:"Waitlist",action:"SignUp",label:a.courseKey}),g.remove("udacity_notify_me_clicked_recently")),{variant:"nanodegree is full, student is waitlisted",
statusMessage:"You will be emailed when enrollment opens "+b(a.courseKey).start,statusSuccess:!0}):{variant:"nanodegree is full, student not waitlisted, not enrolled",text:"Notify me",sidenote:"when nanodegree re-opens",statusMessage:"<strong>Next enrollment opens "+b(a.courseKey).start+".</strong><br>You can start the program immediately after you enroll.",action:function(){g.set("udacity_notify_me_clicked_recently","yes",{expires:new Date((new Date).getTime()+6E5)});a._joinGroup(a.waitlistGroupKey)}}:
{variant:"nanodegree live, student not enrolled",text:"Enroll in Nanodegree",sidenote:"After 1 week free trial",statusMessage:"<strong>Enrollment closes "+b(a.courseKey).end+".</strong><br>You can start the program immediately after you enroll. ",action:function(){h.pushTrackingEvent("nanodegreeEnrollment");"nd801"==a.courseKey?f.location.href="/nanodegree/android-expectation-quiz":a._purchaseCourse()}}:{variant:"nanodegree not open for paid enrollment",sidenote:"This nanodegree is not yet available for enrollment"}};
a=_.extend(a,a.enrollmentActions);a.productLaunchDate=new Date(a.productLaunchDateString);a.hasProductLaunched=a.enrollmentActions.isLaunched;a.isVIP=a.isAccessible&&(!a.isAvailable&&!a.isLaunched||a.canEditContent)&&a.getNanodegreeButtonInfo().action!==c;a.isFull=a.isClassFull&&!(a.isPaidInterested||a.isPaidEnrolled||a.isPaidGraduated)}}}]);angular.module("overview").directive("courseEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","courseState","modal","googleTagManager",function(a,d,b,c,e,f,g,h,i){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/course_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){a.courseState=g;a.currentHighlightedFeature=0;a.freeCourseActionDefaultSectionTitle="Access Course Materials";a.paidCourseActionDefaultSectionTitle=
...
b,controller:"passwordReset"})}]);angular.module("account").controller("accountAuth",["$scope","$location",function(a,d){a.initialSearch=d.search();d.replace().url(d.path())}]);angular.module("account").controller("passwordReset",["$scope","$sce","validator","users",function(a,d,b,c){var e=a.initialSearch.code,f=a.initialSearch.user_key;a.submit=function(){if(!a.buttonDisabled){a.buttonDisabled=!0;a.fieldErrors=null;a.errorMessage=null;a.successMessage=null;var g=b.check({password:{pretty:"your new password",value:a.password,validators:[{type:"required",chained:[{type:"strLen",args:[7,void 0]}]}]},passwordConfirm:{pretty:"confirmed password",value:a.passwordConfirm,validators:[{type:"required",
...
function(b){b=b.status;a.buttonDisabled=!1;a.errorMessage=400===b?d.trustAsHtml("We couldn't find an account with that email."):409===b?d.trustAsHtml("We have recently sent a reset email to that address. It may have been marked as spam."):d.trustAsHtml("Something went wrong and we were unable to send your reset email.")}):(a.fieldErrors=e.errorText,a.buttonDisabled=!1)}}}]);angular.module("account").controller("signInForm",["$scope","$q","$sce","session","users","currentUser","groups","validator","google","facebook","$location","safelyRedirect",function(a,d,b,c,e,f,g,h,i,j,k,l){var m=a.initialSearch.next;f.userIsLoggedIn()&&l(m);a.showTopBox=a.initialSearch.showMessage;var n=function(){var b=a.initialSearch.enroll,c=a.initialSearch.enroll_state||"enrolled",e=a.initialSearch["join-group"],b=b?f.enroll(b,c,!0):d.when(!0),h=e?f.fetchFullUser().then(function(){return g.addMember(e,
f.get("key"))}):d.when(!0);return b.then(function(){return h.then(function(){l(m)})})},p=function(c){a.errorMessage=b.trustAsHtml("We were unable to validate your account.");return d.reject(c)},q=function(c){if(403===c.data.status)a.errorMessage=b.trustAsHtml('Your social account isn\'t connected yet, you can sign in with an existing account, or <a href="#!/signup">Sign Up</a> to get started.');else{if(502===c.data.status)return p(c);a.errorMessage=b.trustAsHtml("Something went wrong and we're currently looking into it.")}return d.reject(c)};
a.signInEmail=function(){a.buttonDisabled=!0;a.fieldErrors=null;a.email=$("#email").val();a.password=$("#password").val();var e=h.check({email:{pretty:"email address",value:a.email,validators:[{type:"required",chained:[{type:"email"}]}]},password:{pretty:"password",value:a.password,validators:[{type:"required"}]}});e.valid?c.put({udacity:{username:a.email,password:a.password}}).then(n,function(c){a.buttonDisabled=!1;a.errorMessage=b.trustAsHtml("The email or password you entered is invalid");return d.reject(c)}):
(a.fieldErrors=e.errorText,a.buttonDisabled=!1)};a.signInFacebook=function(){return j.getAuthResponse().then(function(a){return c.put({facebook:{signed_request:a.signedRequest}}).then(n,q)},p)};a.signInGoogle=function(){i.getToken(!1).then(function(a){return c.put({google:{token:a.code}}).then(n,q)},p)};a.hasLongCookieString=function(){return 3E3<document.cookie.length}}]);angular.module("account").controller("signUpForm",["$scope","$q","$sce","$timeout","session","users","currentUser","groups","validator","google","facebook","$location","safelyRedirect","googleTagManager","retry","cookieJar","universalAnalytics",function(a,d,b,c,e,f,g,h,i,j,k,l,m,n,p,q,r){a._removeEmailCookie=function(){q.exists("emailAddressForSignUp")&&q.remove("emailAddressForSignUp",{path:"/"})};var t=function(){var b=function(){var b=a.initialSearch.next;b?m(b):m("/")},c=a.initialSearch.enroll,
e=a.initialSearch.enroll_state||"enrolled",f=a.initialSearch["join-group"],e=c?g.enroll(c,e,!0):d.when(!0),i=f?g.fetchFullUser().then(function(){return h.addMember(f,g.get("key"))}):d.when(!0),j,k;a._removeEmailCookie();j=c?r.trackEvent({category:"SignUp",action:"Enroll",label:c}):r.trackEvent({category:"SignUp",action:"Direct"});k=n.pushTrackingEvent("RegistrationCompleted");return e["finally"](function(){return i["finally"](function(){return j["finally"](function(){return k["finally"](b)})})})},
w=function(c){a.errorMessage=b.trustAsHtml("We were unable to validate your account.");return d.reject(c)},u=function(c){a.errorMessage=b.trustAsHtml("We were unable to access your account.");return d.reject(c)},s=function(c){409===c.data.status?(a.errorMessage=b.trustAsHtml("This account already exists, please sign in to continue."),a._removeEmailCookie()):a.errorMessage=b.trustAsHtml("Something went wrong and we're currently looking into it.");a.buttonDisabled=!1;return d.reject(c)};a.signUpEmail=
...
first_name:a.firstName,last_name:a.lastName,password:a.password,tos_accepted:!0}).then(t,s):(a.fieldErrors=b.errorText,a.buttonDisabled=!1)};a.signUpFacebook=function(){return k.getAuthResponse().then(function(a){return k.getMeResponse().then(function(b){return f.registerUser({email_address:b.email,first_name:b.first_name,last_name:b.last_name,facebook:{signed_request:a.signedRequest},tos_accepted:!0}).then(t,s)},u)},w)};a.signUpGoogle=function(){j.getToken(!1).then(function(a){return e.put({google:{token:a.code}}).then(t,
function(){return p(j.getMeResponse,5,100).then(function(a){return j.getToken(!0).then(function(b){return f.registerUser({email_address:a.email,first_name:a.given_name,last_name:a.family_name,google:{token:b.code},tos_accepted:!0}).then(t,s)},w)},u)})},w)};q.exists("emailAddressForSignUp")&&(a.email=q.get("emailAddressForSignUp"))}]);angular.module("account").controller("viewerSettings",["$scope","currentUser","users","techDetect","$window",function(a,d,b,c){a.isBrowserIE="Explorer"===c.browserStats().browser;a.videoQualities=[{label:"Automatic",value:"default"},{label:"360p",value:"medium"},{label:"480p",value:"large"},{label:"720p",value:"hd720"},{label:"1080p",value:"hd1080"}];a.playbackRates=[{label:"0.25x",value:0.25},{label:"0.5x",value:0.5},{label:"Normal",value:1},{label:"1.5x",value:1.5},{label:"2x",value:2}];var e=d.getUser();
...
a.save=function(){a.serverSuccess=a.serverError="";a.saving=!0;e.site_preferences={use_html5_player:a.settings.useHtml5Player,auto_advance:a.settings.autoAdvance,playback_rate:a.settings.playbackRate.value,video_quality:a.settings.videoQuality.value};b.put(e).then(function(){a.saving=!1;a.serverSuccess="Classroom Settings Saved"},function(b){a.saving=!1;a.serverError=b.error})}}]);angular.module("payment").controller("checkoutPage",["$scope","paymentFlow","$routeParams","$location","api","currentUser","cacheVersion","modal","dateTime","$timeout","universalAnalytics",function(a,d,b,c,e,f,g,h,i,j,k){f.get("_registered")||(window.location.href="/account/auth#!/signup?next="+encodeURIComponent(window.location.href));a.$on("$routeChangeSuccess",function(){k.trackVirtualPageView();if(angular.isDefined(b.stepNumber)&&d.isInFlow())d.goToStep(b.stepNumber);else{var e=[];c.search().products?
(e=c.search().products.split(","),d.begin(e),a.flow=d.getCurrentFlowData()):window.history.back()}});a.getCurrentDate=function(){return i.getCurrent()};a.isProductLaunched=function(a){return a&&a.launch_date&&new Date(a.launch_date)<i.getCurrent()};a.isProductNotLaunched=function(a){return a&&!a.was_launched};a.getGoToNanodegreeLink=function(){return a.flow&&"nd001"===a.flow.uriEncodedCourseKey?"/teams/#/onboarding/"+a.flow.uriEncodedCourseKey:"/me"};a.getDescStringByCourseType=function(a){switch(a){case "Degree":return"Nanodegree";
case "Career":return"program";case "Course":return"course"}};a.getDatePlusDays=function(a,b){return a?new Date(a.getTime()+864E5*b):null};a.step={};a.submitStep=function(b){a.step.submitting=!0;d.submitStep(b).then(function(){a.step.submitting=!1;$("html,body").animate({scrollTop:0})})};a.getCacheBustingUrl=function(a){return a&&a+"?"+g};a.currentUserName=f.getFullName();a.currentUserEmail=f.get("email").address;a.currentUserNickname=f.get("nickname");a.getCurrentUserIsVerified=function(){return f.get("email")._verified};
a.getCurrentStep=d.getCurrentStep;a.getCurrentFlowSteps=d.getCurrentFlowSteps;j(function(){a.getCurrentUserIsVerified()||h.activate("verify email")},1)}]);angular.module("page.payment",["core"]).config(["$routeProvider",function(a){a.when("/:stepNumber",{}).otherwise({redirectTo:"/0"})}]);angular.module("payment").constant("DAY_IN_MILLISECONDS",864E5).factory("fullClassExperienceFlowDefinition",["$q","stripeCreditCard","validator","api","currentUser","products","customers","couponCode","users","$timeout","$log","nodes","DAY_IN_MILLISECONDS","userTrials","googleTagManager","universalAnalytics",function(a,d,b,c,e,f,g,h,i,j,k,l,m,n,p,q){var r=function(a){return"card_declined"===a.code?"Your card was declined. Please try again. If this issue persists, please contact payment-support@udacity.com.":
"processing_error"===a.code?"An error occurred while processing your card. Please try again.If this issue persists, please contact payment-support@udacity.com.":a.code?a.message:"An error occurred while processing your card. Please check your information and try again. If this issue persists, please contact payment-support@udacity.com."},t=function(a){return a&&_.map(a._course_groups,function(a){return a.course_ref&&a.course_ref.key})},w=function(b,d){var e={product_keys:d.productKeys};b&&b.id&&(e.stripe_token=
b.id);d.coupon&&d.coupon.valid&&(e.coupon_id=d.coupon.key);e=c.post("/customers/me/purchases",e).then(function(a){return a.data.purchase},function(b){d.generalPaymentFormError=b.data.error?r(b.data):"We are having difficulties processing your request. If this error keeps appearing please contact payment-support@udacity.com.";b.data.was_charged&&alert("Error - your card was charged successfully but an error occured.Please contact us at payment-support@udacity.com immediately and we'll get this sorted out. Your spot is reserved. Please do NOT pay again.");
return a.reject(b)});e.then(function(){return d.course.isNanodegree&&"nd001"===d.course.key?i.setOnboardingFlag("me",d.course.key):a.when()});return e};return[{label:"Checkout",view:"/templates/angular/payment/payment_form.html",onStart:function(b,e){var i=[f.get(e.productKeys[0]),g.get("me")];if(h){var j=c.get("/coupons/"+h+"/compute_discount",{product_key:e.productKeys[0]}),j=j.then(function(a){e.coupon=a.data.coupon;a.data.coupon.valid&&(e.coupon.discounted_price=a.data.result)},function(){e.coupon=
{valid:!1};return null});i.push(j)}a.all(i).then(function(a){e.product=a[0];var b=_.first(e.product._course_groups).course_ref.key;l.get(b).then(function(a){var b=a.catalog_entry._image?a.catalog_entry._image.serving_url:null;e.confirmationStepLabel={Career:"Start program",Degree:"Start Nanodegree",Course:"Start course"}[a.getCourseType()];e.course={key:a.key,imageUrl:b,isNanodegree:a.isNanodegree(),isCareer:a.isCareer(),courseType:a.getCourseType()};p.pushTrackingEvent("checkoutStart",{productName:e.product.name,
productPrice:e.product.amount,orderNodeKey:e.course.key,isNanodegree:a.isNanodegree,isCareer:a.isCareer,getCourseType:a.getCourseType})});b=e.product.trial_period_days;e.inTrialPeriod=0<b;e.trialPeriodStarts=new Date(Date.now()+b*m);e.customer=a[1];e.customerCard=d.getDefaultCard(e.customer);e.cardIsLoaded=!0;e.uriEncodedCourseKey=window.encodeURIComponent(t(e.product))})},onJump:function(a){return a.paymentConfirmed?!1:!a.paymentConfirmed},onSubmit:function(b,c){if(c.customerCard)return w(!1,c);
var e=b.creditCard||{},f=d.checkValidity(e);c.creditCardErrors=f.errorText;if(!f.valid)return!1;f=(c.product&&c.product.name)+", "+t(c.product);return d.createPaymentToken(f,e).then(function(a){return w(a,c)},function(b){c.generalPaymentFormError=r(b.error);return a.reject(b)})}},{getLabel:function(a){return a.confirmationStepLabel},view:"/templates/angular/payment/payment_confirmation.html",onStart:function(a,b){b.paymentConfirmed=!0;b.payment=a;var c=b.product&&(b.product.amount||0)/100,d=null;
try{d=_.find(a.customer.subscriptions,function(a){return a.plan.id===b.product.key}).id}catch(e){k.error("Failed to get Transaction Id",e)}q.trackTransaction({transactionId:d,transactionTotal:c,transactionAffiliation:"Udacity",transactionProducts:[{name:b.product&&b.product.name||"Missing product name, FILL IN IN CONTENT EDITOR ASAP FOR "+_.first(t(b.product)),sku:"DD44",price:c,quantity:1,category:_.first(t(b.product))}]});p.pushTrackingEvent("CompletedOrder",{transactionVal:c,transactionOrderId:d,
transactionPromoCode:h,orderNodeKey:b.course.key,isNanodegree:b.course.isNanodegree})}}]}]);angular.module("payment").factory("paymentFlow",["$q","paymentState","$location",function(a,d,b){return{begin:function(a){a=d.startFlow(a);if(a.onStart)a.onStart(null,d.getCurrentFlowData());b.path("/"+d.getCurrentStep().number.toString())},submitStep:function(c){var e=a.defer();(c=d.getCurrentStep().onSubmit(c,d.getCurrentFlowData()))?a.when(c).then(function(a){var c=d.goToNextStep();if(c.onStart)c.onStart(a,d.getCurrentFlowData());e.resolve();b.path("/"+c.number.toString())},function(){e.resolve()}):
e.resolve();return e.promise},goToStep:function(a){a=window.parseInt(a,10);if(a!==d.getCurrentStep().number&&(a=d.getStepNumber(a),!a.onJump||a.onJump(d.getCurrentFlowData()))){if(a.onStart)a.onStart(null,d.getCurrentFlowData());b.path("/"+d.goToNextStep().number.toString())}},isInFlow:d.isInFlow,getCurrentStep:d.getCurrentStep,getCurrentFlowSteps:d.getCurrentFlowSteps,getCurrentFlowData:d.getCurrentFlowData}}]);angular.module("payment").factory("paymentFlowDefinitions",["fullClassExperienceFlowDefinition",function(a){var d={"default":a};_.each(d,function(a){_.each(a,function(a,b){a.number=b})});return{get:function(){return d["default"]}}}]);angular.module("payment").controller("paymentForm",["$scope","api",function(a,d){a.sendVerificationEmail=function(){d.post("/users/send_verification_email").success(function(){a.resentVerificationEmail=!0}).error(function(a){console.error("Something went wrong",a)})};a.refresh=function(){window.location.reload()}}]);angular.module("payment").factory("paymentState",["paymentFlowDefinitions",function(a){var d=null,b=null,c={};return{startFlow:function(e){d=a.get(e);b=d[0];c={productKeys:e||[]};return b},getCurrentStep:function(){return b},getStepNumber:function(a){return d[a]},isInFlow:function(){return!!d},getCurrentFlowSteps:function(){return d},getCurrentFlowData:function(){return c},setCurrentStepNumber:function(a){return b=d[a]},goToNextStep:function(){return b=d[b.number+1]}}}]);angular.module("payment").factory("stripeCreditCard",["$http","$q","$rootScope","validator",function(a,d,b,c){var e=window.Stripe,f=!!e,g={createPaymentToken:function(a,c){var j=d.defer(),k=g.checkValidity(c);k.valid?f&&e.createToken({subject:a,name:c.nameOnCard,number:c.number,cvc:c.cvc,exp_month:c.expiryMonth,exp_year:c.expiryYear},function(a,c){b.$apply(function(){c.error?j.reject(c):j.resolve(c)})}):j.reject(k);return j.promise},checkValidity:function(a){return c.check({nameOnCard:{pretty:"cardholder's name",
...
g.pending[e]&&g.pending[e].readyNotification(g.run);if(null!==b)g.pending=_.without(g.pending,b),b["finally"](g.run),g.running.push(b),d(b.start);else break}}};return g};c=a.make;return a}]);angular.module("user").factory("currentUser",["$log","$q","$rootScope","users","basicUser","nodes","nodeUtility","userUtility","cohortsGateway","universalAnalytics",function(a,d,b,c,e,f,g,h,i,j){var k=angular.copy(e),l=null,m=null,n={get:function(a){return k[a]},getUser:function(){return k},getFullName:function(){return h.getFullName(k)},isStaff:function(){if(k._memberships)return 0<_.filter(k._memberships,function(a){return-1<a.group_ref.key.indexOf("staff")}).length},getEnrolledCourses:function(){return _.chain(n.get("_enrollments")).filter(function(a){if(a&&
"enrolled"===a.state)return!0}).map(function(a){return a.node_key}).value()},getEnrolledNanodegreeKeys:function(){return _.filter(n.getEnrolledCourses(),function(a){return 0===a.indexOf("nd")})},getEnrolledCareerKeys:function(){return _.filter(n.getEnrolledCourses(),function(a){return 0===a.indexOf("ca")})},fetchGraduatedNanodegreeKeys:function(){return n.fetchCertificates().then(function(a){return _.chain(a).map(function(a){return a.node_ref.key}).filter(function(a){return 0===a.indexOf("nd")}).value()})},
fetchGraduatedCourseKeys:function(){return n.fetchCertificates().then(function(a){return _.map(a,function(a){return a.node_ref.key})})},fetchGraduatedCareerKeys:function(){return n.fetchCertificates().then(function(a){return _.chain(a).map(function(a){return a.node_ref.key}).filter(function(a){return 0===a.indexOf("ca")}).value()})},fetchEnrolledAndGraduatedCourseKeys:function(){return n.fetchFullUser().then(function(){return n.fetchGraduatedCourseKeys()}).then(function(a){return _.union(n.getEnrolledCourses(),
a)})},fetchEnrolledAndGraduatedNanodegreeKeys:function(){return n.fetchGraduatedNanodegreeKeys().then(function(a){return _.union(n.getEnrolledNanodegreeKeys(),a)})},fetchEnrolledAndGraduatedCareerKeys:function(){return n.fetchGraduatedCareerKeys().then(function(a){return _.union(n.getEnrolledCareerKeys(),a)})},getGroupKeys:function(){return _.chain(n.get("_memberships")).filter(function(a){return a.group_ref&&"Group"===a.group_ref.ref}).map(function(a){return a.group_ref.key}).value()},fetchStudyGroups:function(){return c.getStudyGroups("me")},
getEmail:function(){return h.getEmail(k)},setUser:function(a){angular.copy(angular.copy(a),k)},fetchFullUser:function(a){var b=a?{cacheBust:Math.random()}:{};if(a)return c.get("me",b).then(function(a){n.setUser(a);return a});l||(l=c.get("me",b).then(function(a){n.setUser(a);return a}));return l},fetchCertificates:function(){return k._certificates?d.when(k._certificates):c.getCertificates("me").then(function(a){return k._certificates=a})},checkIfFirstChatVisit:function(){return c.checkIfFirstChatVisit("me")},
setFirstChatVisit:function(){return c.setFirstChatVisit("me")},checkNewHomeBanner:function(){return c.checkNewHomeBanner("me")},setNewHomeBanner:function(){return c.setNewHomeBanner("me")},setAddToCalFlag:function(a){return c.setAddToCalFlag("me",a)},fetchCohorts:function(){m||(m=n.fetchFullUser().then(function(a){return d.all(_.map(a._cohort_keys,function(a){return i.get(a)}))},function(b){a.error(b)}));return m},userIsLoggedIn:function(){return k._registered},isEnrolledIn:function(a){return _.some(k._enrollments,
function(b){return b.node_key===a&&"enrolled"===b.state})},isEnrolledForCreditIn:function(a){var b=["151101088","150207572","151148782","151059885","151254701"];return void 0!==_.find(k._enrollments,function(c){var d=_.pluck(c.group_refs,"key");return c.node_key===a&&"enrolled"===c.state&&0<_.intersection(d,b).length})},isCourseEmailSubscribed:function(a){return 0<_.filter(k._enrollments,function(b){return b.node_key===a&&b.email_ok}).length},enroll:function(a,d,e){d=d||"enrolled";return c.setEnrollments("me",
[a],d).then(function(a){k._enrollments=k._enrollments||[];_.each(a,function(a){var b=_.find(k._enrollments,function(b){return b.node_key===a.node_key});b?k._enrollments[_.indexOf(k._enrollments,b)]=a:k._enrollments.push(a)});if(1===a.length){b.$broadcast("modifiedEnrollment",a);var c=d.slice(0,1).toUpperCase()+d.slice(1,-2),c=j.trackEvent({category:"Enrollment",action:c,label:a[0].node_key});return e?c.then(function(){return a},function(){console.warn("Failed to push enrollment to Universal Analytics");
return a}):a}return a})},changeEnrollmentSettings:function(a,b){return c.changeEnrollmentSettings(a,"me",b)},getEnrollmentsWithState:function(a){return _.filter(k._enrollments,function(b){return b.state===a})},getTags:function(){return c.getTags("/users/me/tags")},setTag:function(a,b){var e=n.get("tags");if(_.findWhere(e,{namespace:a,tag:b}))return d.when(e);var f=e.concat([{namespace:a,tag:b}]);k.tags=f;return c.put({key:n.get("key"),tags:f}).catch(function(a){k.tags=e;return d.reject(a)})},removeTag:function(a,
b){var e=n.get("tags");if(!_.findWhere(e,{namespace:a,tag:b}))return d.when(e);var f=_.reject(e,function(c){return c.namespace===a&&c.tag===b});k.tags=f;return c.put({key:n.get("key"),tags:f}).catch(function(a){k.tags=e;return d.reject(a)})},isNanodegreeStudent:function(){return Boolean(_.find(k._enrollments,function(a){return"nd"===a.node_key.slice(0,2)}))}};return n}]);angular.module("user").directive("userMenu",["currentUser","session",function(a,d){return{restrict:"A",link:function(b){b.isLoggedIn=a.userIsLoggedIn;b.user=a.getUser;b.isNanodegreeStudent=a.isNanodegreeStudent();var c=[/\/account/,/\/me/,/\/checkout/];b.logOut=function(){d.terminate().then(function(){var a=window.location.pathname;_.some(c,function(b){return b.test(a)})?window.location="/":window.location.reload()})}}}}]);angular.module("user").factory("userUtility",[function(){return{getFullName:function(a){if(a)return a.first_name&&a.last_name?a.first_name+" "+a.last_name:a.first_name||a.last_name},getEmail:function(a){return a.email&&a.email.address}}}]);angular.module("utility").directive("animatedToggle",function(){return{restrict:"A",link:function(a,d,b){b.toggleTarget||console.error("You must provide a toggle-target with a selector for the child element to toggle");b.toggler||console.error("You must provide an element to trigger the toggle");var c=d.find(b.toggleTarget),a=d.find(b.toggler);c||console.error("Element to toggle ("+b.toggleTarget+") not found!");a||console.error("Element to trigger toggle ("+b.toggler+") not found!");$(a).on("click",
...
i=null,j=0,k=f.length;j<k;j++){i=f[j].match(/([^=]+)=/i);if(angular.isArray(i))try{g=decodeURIComponent(i[1]),h=!1===c?f[j].substring(i[1].length+1):decodeURIComponent(f[j].substring(i[1].length+1))}catch(l){}else g=decodeURIComponent(f[j]),h="";d[g]=h}return d};return{exists:function(a){if(!angular.isString(a)||""===a)throw new TypeError("$cookieJar.exists(): Cookie name must be a non-empty string.");return d(document.cookie,!0).hasOwnProperty(a)},get:function(a,c){var c=angular.isObject(c)?c:{},
...
identity:"Linux"}],i=function(a){if(null===b.browser||a)b.browser=e(g)||"An unknown browser";return b.browser},j=function(a){if(null===b.version||a)i(),b.version=f(navigator.userAgent)||f(navigator.appVersion)||"an unknown version";return b.version},k=function(a){if(null===b.os||a)b.os=e(h)||"an unknown OS";return b.os},l=function(a){if(null===b.cookies||a)document.cookie="cookietest=1",b.cookies=-1!==document.cookie.indexOf("cookietest="),document.cookie="cookietest=1; expires=Thu, 01-Jan-1970 00:00:01 GMT";
...
if(null!==f){var g=+f[1],h=+f[3],f=new Date(h,g-1,+f[2]);return(""+f.getFullYear()).slice(-2)===(h+"").slice(-2)&&f.getMonth()===g-1?a:d}return d}};return{check:function(a){var c,e={valid:!0,errorText:{}},f,g;for(g in a)if(a.hasOwnProperty(g)){c=a[g];for(var h=0;h<c.validators.length;h++)if(f=c.validators[h],"undefined"===typeof f.disabled||!1===f.disabled)if("function"===typeof d[f.type]){var i=c.value,j=c.pretty||g,k=d[f.type](i,j,f.args||[]);k.valid?f.hasOwnProperty("chained")&&(k={},k[g]={pretty:j,
value:i,validators:f.chained},f=this.check(k),!1===f.valid&&(e.valid=!1,e.errorText[g]=e.errorText[g]||[],e.errorText[g]=e.errorText[g].concat(f.errorText[g]))):(e.valid=!1,e.errorText[g]=e.errorText[g]||[],e.errorText[g].push("undefined"===typeof f.failMsg?k.errorText.charAt(0).toUpperCase()+k.errorText.slice(1):f.failMsg))}else console.warn("You tried to use a validator that doesn't exist! The name you tried to use was: "+f.type)}return e}}}]);angular.module("viewer").controller("contentGate",["$scope","modal","currentUser","$location",function(a,d,b,c){a.signUpAndReturnToCourse=function(a){window.location.href="/account/auth#!/signup?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(c.path())+"&enroll="+encodeURIComponent(a)};a.signInAndReturnToCourse=function(a){window.location.href="/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(c.path())+"&enroll="+encodeURIComponent(a)};a.enrollInCourse=function(c){a.enrollRequestPending=
...
ma006:["We recommend having a pencil and paper handy for this class."],ma008:["We recommend having a pencil and paper handy for this class."],st095:["We recommend having a pencil and paper handy for this class.",'Want to read about some fascinating real-world statistics? Check out Dan Ariely\'s book "Predictably Irrational"!']});angular.module("viewer").constant("videoViewedTimeThreshold",3).controller("viewerPage",["$scope","lesson","$location","$routeParams","lessonActivityTracker","$timeout","videoViewedTimeThreshold","youtubeVideoPlayer","viewerSettings","cacheVersion","loadingMessages","lessonPrefetcher","tags","libraryLoader","viewerPartialMap","examMode","techDetect","api","sessionLapsed","modal","currentUser","nodeUtility","canEditNotes","guidedTour","users","qualaroo","$log","showChat","universalAnalytics",function(a,
d,b,c,e,f,g,h,i,j,k,l,m,n,p,q,r,t,w,u,s,x,D,I,J,F,G,H,E){function A(){var b;b=_.without(_.union(k.general,k[v]),null,void 0,"");a.viewerLoadingMessage=b[_.random(b.length-1)];a.isViewerLoading=!0}function z(a,b,c){if(a){var d=p[a.model];if(d){if(!c||d.extension)return"/templates/angular/viewer/partials/"+d.prefix+b+"?"+j}else console.error("Unrecognized morsel type "+a.model)}else if(!c)return"/templates/angular/viewer/partials/loading"+b+"?"+j}function B(a){f.cancel(y);("Video"===a.model||"SketchVideo"===
a.model)&&h.addEventListener("videoPlay",function(){f.cancel(y);y=f(C(a.key),1E3*g,!1)},{removeAfterFired:!0})}function C(a){return function(){if(h.getCurrentTime()>=g){var b=h.getCurrentTime();h.emitEvent("videoPause",b);h.emitEvent("videoPlay",b+1);d.markMorselAsCompleted(a)}else y=f(C(a),500,!1)}}a.modalsUrl="/templates/viewer/partials/viewer_modals.html?"+j;a.getCoachServicesUrl=function(){if(a.course)return"/conditional/tutoring?course_id="+window.encodeURIComponent(a.course.key)+"&cache_bust="+
j};a.userIsLoggedIn=s.userIsLoggedIn();a.canEditNotes=D;a.course=null;a.lessons=null;a.lesson=null;a.morsels=null;a.morsel=null;a.tidbit=null;var v=b.path().match("/"+m.course+"([^/]+)"),v=v?v[1]:null;a.courseKeyFromUrl=v;v||(window.location.href="/");t.addEventListener("sessionExpired",function(){window.location.href="/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(b.path())});w&&(window.location.href="/account/auth#!/signin?next=%2Fcourse%2Fviewer%23!"+encodeURIComponent(b.path()));
d.addEventListener("lessonPermissionDenied",function(){window.location.href="/course/"+v});d.addEventListener("courseChange",function(a){if((!a.lessons||0===a.lessons.length)&&!a.lastLessonVisited&&!c.lessonKey)window.location.href="/course/"+v}).addEventListener("coursePermissionDenied",function(){c.lessonKey||(window.location.href="/course/"+v)});d.addEventListener("lessonChange",function(a){if(!a.morsels||0===a.morsels.length)window.location.href="/course/"+v});a.isViewerLoading=!0;d.addEventListener("courseChange",
function(){n.loadLibraries(["codemirror","mathquill"]).then(function(){},function(){G.error("Classroom failed to load a required library");alert("Failed to load some required parts of the course! Please refresh the page. If this issue persists, please contact support@udacity.com. Thanks!")})}).addEventListener("morselChange",function(){a.isViewerLoading=!1});d.addEventListener("courseChange",function(b){a.course=b.course;a.lessons=b.lessons;a.enrollment=_.find(s.get("_enrollments"),function(a){return a.node_key===
b.course.key});a.premiumAccess=x.hasPermissionTo(a.course,"view-paid-supplemental-media")||a.enrollment&&(x.isCurrentEnrolled(a.enrollment,b.course)||x.isGraduated(a.enrollment,b.course));F.set({isPaid:a.premiumAccess?"yes":"no"})},{replayLast:!0,removeOnDestructionOf:a}).addEventListener("lessonChange",function(b){a.lesson=b.lesson;a.morsels=b.morsels},{replayLast:!0,removeOnDestructionOf:a}).addEventListener("morselChange",function(b){a.morsel=b;B(b)},{replayLast:!0}).addEventListener("tidbitChange",
function(b){(a.tidbit=b.tidbit)&&B(b.tidbit)},{replayLast:!0});d.addEventListener("pendingLessonChange",function(){a.morsels=null;a.morsel=null;a.tidbit=null});a.$on("$routeChangeSuccess",function(b,f,g){if(b=!c.morselKey)if(!g||!f)b=!1;else{var h=g.pathParams,f=f.pathParams;if(_.keys(h).length===_.keys(f).length)b=!1;else{var i=!0;_.each(f,function(a,b){h[b]!==a&&(i=!1)});b=i}}b&&window.history.back();c.courseKey&&c.courseKey!==v&&window.location.reload();g&&E.trackVirtualPageView();if((null===a.course||
a.course.key!==c.courseKey)&&"none"!==c.courseKey)A(),d.addEventListener("courseChange",function(b){c.lessonKey||(b.lastLessonVisited?a.goToLesson(b.lastLessonVisited.key):a.goToLesson(b.lessons[0].key))},{removeAfterFired:!0}),d.changeCourse(c.courseKey);if((null===a.lesson||a.lesson.key!==c.lessonKey)&&c.lessonKey)A(),d.addEventListener("lessonChange",function(b){c.morselKey||(b.lastMorselVisited?a.goToMorsel(b.lastMorselVisited):a.goToMorsel(b.morsels[0]))},{removeAfterFired:!0}),d.changeLesson(c.lessonKey);
if((null===a.morsel||a.morsel.key!==c.morselKey)&&c.morselKey)e.logNodeVisit("morsel"),a.lesson&&a.lesson.key===c.lessonKey?d.changeMorsel(c.morselKey):d.addEventListener("lessonChange",function(){d.changeMorsel(c.morselKey)},{removeAfterFired:!0});if(null===a.tidbit||a.tidbit.key!==c.tidbitKey)c.tidbitKey&&e.logNodeVisit("tidbit"),a.morsel&&a.morsel.key===c.morselKey?d.changeTidbit(c.tidbitKey):d.addEventListener("morselChange",function(){d.changeTidbit(c.tidbitKey)},{removeAfterFired:!0})});a.alert=
function(a){alert(a)};a.log=function(a){console.log(a)};a.getCurrentMorselType=function(){return a.morsel?a.morsel.model:null};a.getStyleClassesForMorsel=function(b){var c="";if(a.morsel)if("Exercise"===b.model){if(b.completed||b.lecture_ref&&b.lecture_ref.completed)c+="is-viewed";if(b.key===(a.morsel.containingExercise?a.morsel.containingExercise.key:a.morsel.key))c+=" is-current"}else b.completed&&(c+="is-viewed"),a.morsel.key===b.key&&(c+=" is-current");return c};a.checkToShowChat=function(){if(a.enrollment)return"enrolled"===
a.enrollment.state&&s.userIsLoggedIn()};a.showGroupChat=!1;H.getGroupChatPromise().then(function(b){a.showGroupChat=b});a.getPlayerPartialForCurrentMorsel=function(){return z(a.morsel,"_player.html")};a.getPlayerExtensionPartialForCurrentMorsel=function(){return z(a.morsel,"_extension.html",!0)};a.getSidePanelPartialForCurrentMorsel=function(){return z(a.morsel,"_side_panel.html")};a.goToMorsel=function(e){(!e||!e.key)&&console.error("Cannot go to invalid morsel "+e);(!a.morsel||e.key!==a.morsel.key)&&
f(function(){if("Exercise"===e.model){var a=e.lecture_ref||e.quiz_ref;d.announcePendingMorselChange(a);b.path("/"+m.course+c.courseKey+"/"+m.lesson+c.lessonKey+"/"+m.exercise+e.key+"/"+m.morsel+a.key)}else d.announcePendingMorselChange(e),e.containingExercise?b.path("/"+m.course+c.courseKey+"/"+m.lesson+c.lessonKey+"/"+m.exercise+e.containingExercise.key+"/"+m.morsel+e.key):b.path("/"+m.course+c.courseKey+"/"+m.lesson+c.lessonKey+"/"+m.morsel+e.key)})};a.goToTidbit=function(d){!d&&a.tidbit?c.exerciseKey?
b.path("/"+m.course+c.courseKey+"/"+m.lesson+c.lessonKey+"/"+m.exercise+c.exerciseKey+"/"+m.morsel+c.morselKey):b.path("/"+m.course+c.courseKey+"/"+m.lesson+c.lessonKey+"/"+m.morsel+c.morselKey):(!a.tidbit||d.key!==a.tidbit.key)&&f(function(){b.path("/"+m.course+c.courseKey+"/"+m.lesson+c.lessonKey+"/"+m.exercise+d.containingExercise.key+"/"+m.morsel+d.containingExercise.quiz_ref.key+"/"+m.tidbit+d.key)})};a.goToNextMorsel=function(){var b=a.morsel,c=a.morsels.length;b.containingExercise&&(b=b.containingExercise);
b=b.indexInLesson;b<c-1?a.goToMorsel(a.morsels[b+1]):(h.pauseVideo(),a.course?s.userIsLoggedIn()&&s.isEnrolledIn(a.course.key)?a.lessons&&a.lesson.key===a.lessons[a.lessons.length-1].key?(a.enrollment=_.find(s.get("_enrollments"),function(b){return b.node_key===a.course.key}),u.activate("endOfCourse",{courseIsComplete:a.course.catalog_entry.complete,courseKey:a.course.key,isPaidEnrolled:x.isCurrentEnrolled(a.enrollment,a.course),isGraduated:x.isGraduated(a.enrollment,a.course)})):u.activate("endOfLesson",
{lessonKey:a.lesson.key,userIsLoggedIn:s.userIsLoggedIn()}):s.userIsLoggedIn()?u.activate("endOfLessonEnrollGate",{lessonKey:a.lesson.key,userIsLoggedIn:s.userIsLoggedIn()}):u.activate("endOfLessonSignInGate",{lessonKey:a.lesson.key,userIsLoggedIn:s.userIsLoggedIn()}):u.activate("endOfIsolatedContent"))};a.goToPreviousMorsel=function(){var b=a.morsel;b.containingExercise&&(b=b.containingExercise);b=b.indexInLesson;0<b?a.goToMorsel(a.morsels[b-1]):console.error("Can't go to previous; at beginning of lesson")};
a.goToLesson=function(e){if(!a.lesson||e!==a.lesson.key)d.announcePendingLessonChange(),f(function(){b.path("/"+m.course+c.courseKey+"/"+m.lesson+e)})};a.goToNextLesson=function(){if(a.lessons){var b=a.lessons.length,c=_.find(a.lessons,function(b){return b.key===a.lesson.key}).indexInCourse;0<=c&&c<b-1?a.goToLesson(a.lessons[c+1].key):console.error("Can't go to next; at end of course!")}else console.error("Can't go to next lesson, we're not in a course!")};a.os=r.os(!1);a.isActiveMorsel=function(b){return a.morsel&&
a.morsel.key===b};a.getProgressPercentage=function(){return 77};a.isNanodegreeRelatedCourse=function(a){return a?/\-nd/.test(a.key):!1};var y}]);angular.module("viewer").controller("viewerPlayer",["$scope","lesson","$timeout","$window","currentUser","userTrials",function(a,d,b,c,e,f){a.isPlayerLoading=!0;c=function(a){var b=["attempt-1","attempt-2","control"],a=_.reduce(("skip-button-test-"+a).split(""),function(a,b){return(37*a+b.charCodeAt(0))%1009},0);return b[a%b.length]};a.skipButtonTrial=e.userIsLoggedIn()?f.getOrEnrollManually("skip_button_trial",c,[e.get("key")]):"excluded";a.loadingComplete=function(c){c?b(function(){a.$apply(function(){a.isPlayerLoading=
...
!0,a=$.extend({},a),c.init(a))},{replayLast:!0,removeOnDestructionOf:b})},{removeOnDestructionOf:b,removeAfterFired:!0});d.addEventListener("tidbitChange",function(a){b.tidbitViewerMode=e.getTidbitViewerMode(a.tidbit)},{replayLast:!0,removeOnDestructionOf:b});var h=g.find(".code-mirror-holder"),i=g.find(".editor-file-tabs"),j=function(){h.outerHeight(g.height()-(b.files&&1<b.files.length?i.outerHeight():0))},k=_.debounce(j,750),l=_.throttle(j,200);$(window).on("resize",k);$(window).on("resize",l);
b.$watch("files",function(){window.setTimeout(l,0)});j()}}}]);angular.module("viewer").directive("quizVideoPlayer",["lesson","youtubeVideoPlayer","currentUser",function(a,d,b){return{restrict:"A",controller:"videoPlayer",link:function(c,e){var f=null;d.addEventListener("apiReady",function(){a.addEventListener("tidbitChange",function(a){(a=(f=a.tidbit)?f._video:null)?c.playVideo(a,e):c.pauseVideo()},{replayLast:!0,removeOnDestructionOf:c});d.addEventListener("videoEnd",function(){(!b.get("sitePreferences")||b.get("sitePreferences").autoAdvance)&&f&&f.containingExercise&&
f.containingExercise.answer_ref&&f.containingExercise.answer_ref.key===f.key?c.goToNextMorsel():c.goToTidbit(null)},{removeOnDestructionOf:c})},{replayLast:!0,removeOnDestructionOf:c,removeAfterFired:!0})}}}]);angular.module("viewer").directive("quizWidget",function(){return{restrict:"A",link:function(a,d){var b=!0;a.$watch("widget",function(a,e){b&&e&&(d.css({top:100*e.placement.y+"%",left:100*e.placement.x+"%"}),"TextInputWidget"===e.model||"NumericInputWidget"===e.model?(d.width(100*e.placement.width+"%"),d.height(100*e.placement.height+"%")):"MathInputWidget"===e.model&&d.css({"min-width":100*e.placement.width+"%","min-height":100*e.placement.height+"%"}),b=!1)})}}});angular.module("viewer").directive("readingPlayer",["lesson",function(a){return{restrict:"A",link:function(d){a.addEventListener("morselChange",function(a){"Reading"===a.model&&(d.textFrameContent=a.text,d.loadingComplete())},{replayLast:!0,removeOnDestructionOf:d})}}}]);angular.module("viewer").directive("sidePanelUpsell",["currentUser","cookieJar","nodeUtility","cacheVersion","products","siteExperience","$q","dateTime","$location","$window",function(a,d,b,c,e,f,g,h,i,j){return{restrict:"A",templateUrl:"/templates/viewer/partials/side_panel_upsell.html?"+c,link:function(c){c.isCurrentlyEnrollable=function(a){return!a.catalog_entry.paid_class||!a.catalog_entry.paid_class.open_for_enrollment||!a.catalog_entry.paid_class.class_product_refs?g.when(!1):e.get(_.first(a.catalog_entry.paid_class.class_product_refs).key).then(function(a){if(a.capped)return!1;
if(a.launch_date){var b=h.getCurrent(),a=a.launch_date.split("-"),c=new Date;c.setUTCFullYear(parseInt(a[0],10),parseInt(a[1],10)-1,parseInt(a[2],10));c.setUTCHours(18,0,0,0);return c<b}return!0})};var l=c.$watch("course",function(e){if(e){var g=_.find(a.get("_enrollments"),function(a){return a.node_key===e.key}),g=g&&b.isCurrentEnrolled(g,e);d.exists("cancel-side-panel-upsell")||g||f.managedAccount?c.showBanner=!1:c.isCurrentlyEnrollable(e).then(function(a){c.showBanner=a;c.learnMore="/what-we-offer#!/?courseKey="+
j.encodeURIComponent(e.key)+"&start="+j.encodeURIComponent(i.absUrl())},function(){c.showBanner=!1});l()}else c.showBanner=!1});c.goToPurchase=function(a){j.location.href="/checkout#!/0?products="+j.encodeURIComponent(_.first(a.catalog_entry.paid_class.class_product_refs).key)};c.cancelBanner=function(){d.set("cancel-side-panel-upsell",!0);c.showBanner=!1}}}}]);angular.module("viewer").directive("supplementalMaterialsList",["cacheVersion",function(a){return{templateUrl:"/templates/viewer/partials/supplemental_materials_list.html?"+a}}]);angular.module("viewer").directive("viewerDiscussions",["lesson","$http","cacheVersion","siteExperience","fetchDiscourseLink","currentUser","nodeUtility",function(a,d,b,c,e,f,g){return{restrict:"A",templateUrl:"/templates/viewer/partials/viewer_discussions.html?"+b,controller:["$scope","$attrs","examMode",function(b,d,j){b.examMode=j;b.postsStartIndex=0;b.postsEndIndex=0;b.limitedAccess=c.limitedAccess;b.affiliateExperienceId=c.affiliateExperienceId;a.addEventListener("courseChange",function(c){var d=
c.course.key;b.course=c.course;angular.isString(d)&&"nd"===d.slice(d.length-2)&&(b.isNanodegreeAssociatedCourse=!0,e(d).then(function(a){b.discourseCohortUrl=a}));a.addEventListener("morselChange",function(a){b.morsel=a;b.course&&b.morsel&&!b.limitedAccess&&(b.seeAllCoursePostsUrl="http://discussions.udacity.com/c/standalone-courses/"+b.course.forum_slug,b.askAQuestionUrl="http://discussions.udacity.com/c/standalone-courses/"+b.course.forum_slug+"/create",b.enrollment=_.find(f.get("_enrollments"),
function(a){return a.node_key===b.course.key}),b.isPaidCourse=g.hasPermissionTo(b.course,"view-paid-supplemental-media")||b.enrollment&&(g.isCurrentEnrolled(b.enrollment,b.course)||g.isGraduated(b.enrollment,b.course)),e(b.course.key).then(function(a){b.discourseCohortUrl=a}));if("Degree"==c.course.getCourseType||"Career"==c.course.getCourseType)b.isNanodegree=course.isNanodegree(),b.isCareer=course.isCareer(),e(d).then(function(a){b.discourseCohortUrl=a})},{replayLast:!0,removeOnDestructionOf:b})},
{replayLast:!0,removeAfterFired:!0})}]}}]);angular.module("viewer").directive("viewerFeedback",["validator","recordActivity","cacheVersion","lesson","lessonContentContext","techDetect","youtubeVideoPlayer",function(a,d,b,c,e,f,g){return{templateUrl:"/templates/viewer/partials/viewer_feedback.html?"+b,controller:["$scope","modal",function(b,c){b.form={feedbackReason:{value:null,validators:[{type:"required",failMsg:"Please select the type of feedback you wish to give."}]},feedbackExplanation:{value:null,validators:[{type:"javascript",args:[function(a,
...
code:"confusingContent",explanation:"e.g. course material is not explained correctly"}],k=[{name:"Instructions are unclear in a video or question.",code:"instructionsUnclear",explanation:"Did you check the instructor notes below the video player?"},{name:"A correct answer is not accepted.",code:"correctAnswerNotAccepted",explanation:"Did you check the discussions for additional help?"},{name:"Feedback on submitted answer is not useful.",code:"gradingFeedbackUnhelpful"},{name:"Answer video is unclear.",
code:"answerVideoUnclear"},{name:"A link is broken or directs to the wrong site.",code:"brokenLink"},{name:"There is a problem with the download code file(s).",code:"supplementalMaterialIssue"}],l=[{name:"Instructions are unclear in a video or question.",code:"instructionsUnclear",explanation:"Did you check the instructor notes below?"},{name:"A link is broken or directs to the wrong site.",code:"brokenLink"},{name:"There is a problem with the download code file(s).",code:"supplementalMaterialIssue"}];
b.showFeedbackDialog=function(){b.morselTitle=b.morsel.title;"Video"===b.morsel.model?(g.pauseVideo(),b.feedbackOptions=j):b.feedbackOptions="ImageFormQuiz"===b.morsel.model||"ProgrammingQuiz"===b.morsel.model?k:l;c.activate("feedback")};var m=function(a){for(var a=_.pairs(a),b={},c=0;c<a.length;++c){var d=a[c][0],e=a[c][1];if(_.isObject(e))for(var e=_.pairs(m(e)),f=0;f<e.length;++f)b[d+"."+e[f][0]]=e[f][1];else void 0!==e&&null!==e&&(b[d]=e)}return b};b.submitFeedback=function(){b.formValidationResults=
...
setActiveLanguage:function(a){c=a;b.setOption("mode",e[a]);h.emitEvent("languageChanged",{to:a})},getActiveLanguage:function(){return c},setOptions:function(a){_.each(a,function(a,c){b.setOption(c,a)})},getContents:function(){return b?b.getValue():null},setContents:function(a){b.setValue(a)}};return a.eventEmission(h,["attached","languageChanged","contentChanged"])}]);angular.module("viewer").service("executor",["mixin","api","dateTime","lessonContentContext","lesson","iframeEvaluator","$location",function(a,d,b,c,e,f,g){var h={submitFiles:function(a,j,k){var l=k.operation||"TEST",m=c.getCurrent(),n=b.getCurrentAsUTC(),p={model:"Submission",operation:l,parts:_.map(a,function(a){return{model:"SubmissionPart",marker:a.name,content:a.content}})},q={submission:p,client_route:"!"+g.path()},r=function(a){h.emitEvent("evaluation",{evaluation:a.data.evaluation,submission:p,
context:m,timestamp:n});return a};h.emitEvent("submit");e.updateLastSubmissionForMorsel(j,p);return k.useIframe?f.evaluate(p,j,k.iframeUrl).then(function(a){q.submission.client_execution=a.execution;q.submission.client_execution.raw_result=JSON.stringify(a.execution.raw_result);return d.post("/nodes/"+j+"/evaluation?_method=GET",q,{timeout:3E4}).then(r)},function(){q.execution={model:"SubmissionExecution",raw_result:"",status:"te"};return d.post("/nodes/"+j+"/evaluation?_method=GET",q,{timeout:3E4}).then(r)}):
d.post("/nodes/"+j+"/evaluation?_method=GET",q,{timeout:3E4}).then(r)}};return a.eventEmission(h,["update","submit","evaluation"])}]);angular.module("viewer").factory("iframeEvaluator",["mixin","$q","$timeout","isTrustedDomain",function(a,d,b,c){var e=null,f=null,g=null,h={evaluate:function(a,c,k){var l=d.defer();e=l;f=a;g=k;h.emitEvent("newEvaluation",{nodeId:c,iframeUrl:k});b(function(){l.reject("timeout")},6E4);return l.promise}};window.addEventListener("message",function(a){if(c(a.origin)){var d;a=a.data;try{d=JSON.parse(a)}catch(k){d=a}"ready"===d.messageType?h.emitEvent("postMessageRequest",{submission:f,iframeUrl:g}):"execution"===
d.messageType&&b(function(){e.resolve(d.result)})}},!1);return a.eventEmission(h,["newEvaluation","postMessageRequest"])}]);angular.module("viewer").factory("imageQuiz",["mixin","api","dateTime","lesson","lessonContentContext","$timeout",function(a,d,b,c,e,f){function g(a,b){a&&_.each(b.widgets,function(b){var c=_.find(a.parts,function(a){return a.marker===b.marker});c&&("RadioButtonWidget"===b.model?c.content&&(l.radioGroupAnswers[b.group]=c.marker):l.answers[b.marker]=c.content)})}var h=null,i=null,j=null,k;c.addEventListener("morselChange",function(a){k=a},{replayLast:!0});var l={answers:null,radioGroupAnswers:null,
setQuiz:function(a){h=a;var b=Math.round((new Date).getTime());i=b;l.answers={};_.each(h.widgets,function(a){l.answers[a.marker]=a.initial_value});l.radioGroupAnswers={};h.hasOwnProperty("lastSubmission")?(g(h.lastSubmission,h),l.emitEvent("ready")):d.get("/nodes/"+a.key+"/state").success(function(a){if(k.key===h.key&&b===i){var d=a.nodestates[0]?a.nodestates[0].last_submission_data:null,a=a.nodestates[0]?a.nodestates[0].bin_codes:null;g(d,h);c.updateLastSubmissionForMorsel(h.key,d);c.mergeBinCodesForMorsel(h.key,
a);l.emitEvent("ready")}}).error(function(a){console.error("Error fetching quiz progress data");console.error(a)})},getQuiz:function(){return h},submit:function(){_.each(h.widgets,function(a){"RadioButtonWidget"===a.model&&(l.answers[a.marker]=l.radioGroupAnswers[a.group]===a.marker)});l.emitEvent("submitting",l.answers);if(h.evaluator){var a=Math.round((new Date).getTime()),g=h.key;j=a;var i=e.getCurrent(),q=b.getCurrentAsUTC(),r={model:"Submission",operation:"GRADE",parts:_.map(l.answers,function(a,
b){return{model:"SubmissionPart",marker:b,content:a}})},t={submission:r};c.updateLastSubmissionForMorsel(h.key,r);d.post("/nodes/"+h.key+"/evaluation?_method=GET",t).success(function(b){l.emitEvent("evaluation",{evaluation:b.evaluation,submission:r,context:i,timestamp:q});if(g===k.key&&a===j)if(b.evaluation){c.mergeBinCodesForMorsel(h.key,b.evaluation.bin_codes);if(b.evaluation.passed||0<b.evaluation.score.points_earned)c.markMorselAsCompleted(g),h.containingExercise&&c.markMorselAsCompleted(h.containingExercise.key);
!0===b.evaluation.passed?l.emitEvent("correct",{quiz:h,comment:b.evaluation.comment,binCodes:b.evaluation.bin_codes}):!1===b.evaluation.passed?l.emitEvent("incorrect",{quiz:h,comment:b.evaluation.comment,binCodes:b.evaluation.bin_codes}):null===b.evaluation.passed?l.emitEvent("recorded",{quiz:h,comment:b.evaluation.comment,binCodes:b.evaluation.bin_codes}):console.error("invalid evaluation.passed value:"+b.evaluation.passed)}else l.emitEvent("error",{morselId:h.key,comment:"We encountered an error. Please try submitting again."})}).error(function(){l.emitEvent("error",
{morselId:h.key,comment:"We encountered an error. Please try submitting again."})})}else f(function(){_.reduce(h.widgets,function(a,b){return a&&l.answers[b.marker]===b.correct_value},!0)?l.emitEvent("correct",{morselId:h.key}):l.emitEvent("incorrect",{morselId:h.key})},10)}};return a.eventEmission(l,"ready submitting incorrect correct recorded error evaluation".split(" "))}]);angular.module("viewer").factory("isTrustedDomain",[function(){return function(a){return"https://www.udacity.com"===a||"http://localhost:8080"===a||"http://localhost:8087"===a||"https://assignments-dot-udacity-extras.appspot.com"===a}}]);angular.module("viewer").factory("lesson",["api","$q","mixin","lessonContentContext","typeForTag","freshContent",function(a,d,b,c,e,f){function g(a,b){var c=_.find(a,function(a){for(var c=b.length-1;0<=c;c--){var d=a.content_context[c];if(!d||d.node_ref.key!==b[c].node_key||d.tag!==b[c].tag)return!1}return!0});c&&(c=_.object(_.map(c.content_context,function(a){return[e[a.tag]+"Key",a.node_ref.key]})));return c}var h=null,i=null,j=null,k=null,l=null,m=null,n=null,p={announcePendingCourseChange:function(){p.emitEvent("pendingCourseChange",
{course:h})},changeCourse:function(b){var e=Math.round((new Date).getTime());n=e;d.all([a.get("/nodes/"+b+"?depth=1&fresh="+(!0===f)+"&required_behavior=view&projection=navigation"),a.get("/nodes/"+b+"/state?fresh=true")]).then(function(a){var d=a[0].data,f=a[1].data,k=a=null;if(e===n){h=d.references.Node[b];i=d.references.Node;h.steps_refs=_.reject(h.steps_refs,function(a){return!i[a.key]});if(d=_.find(f.nodestates,function(a){return a.node_ref.key===b}))(k=g(d.last_interactions,c.getCurrent()))&&
k.lessonKey&&(a=i[k.lessonKey]);p.emitEvent("courseChange",{course:h,lessons:_.map(h.steps_refs,function(a,b){var c=i[a.key];c.indexInCourse=b;return c}),lastLessonVisited:a})}},function(a){e===n&&a.status&&(403===a.status||404===a.status)&&p.emitEvent("coursePermissionDenied",b)})},announcePendingLessonChange:function(){p.emitEvent("pendingLessonChange",{lesson:j})},changeLesson:function(b){var e=Math.round((new Date).getTime());m=e;d.all([a.get("/nodes/"+b+"?depth=2&fresh="+(!0===f)+"&required_behavior=view&projection=classroom"),
a.get("/nodes/"+b+"/state?fresh=true")]).then(function(a){if(e===m){var d=a[0].data,f=a[1].data,a=null;j=d.references.Node[b];k=d.references.Node;j.steps_refs=_.reject(j.steps_refs,function(a){return!k[a.key]});_.each(j.steps_refs,function(a,b){var c=k[a.key];if(!c)throw Error("Expected a morsel but got "+JSON.stringify(c,2));"Exercise"===c.model&&(_.each(["lecture_ref","quiz_ref","answer_ref"],function(a){c[a]&&(c[a]=k[c[a].key],c[a]&&(c[a].containingExercise=c))}),_.each(c.tidbits,function(a){a.tidbit_ref=
k[a.tidbit_ref.key];a.tidbit_ref&&(a.tidbit_ref.containingExercise=c)}));k[a.key].indexInLesson=b});_.each(k,function(a){if("ImageFormQuiz"===a.model||"ProgrammingQuiz"===a.model)a.binCodes=[]});if(d=_.find(f.nodestates,function(a){return a.node_ref.key===b}))_.each(d.completed_descendant_node_refs,function(a){p.markMorselAsCompleted(a.key)}),(d=g(d.last_interactions,c.getCurrent()))&&d.morselKey&&(a=k[d.morselKey]);p.emitEvent("lessonChange",{lesson:j,morsels:_.map(j.steps_refs,function(a){return k[a.key]}),
lastMorselVisited:a})}},function(a){e===m&&a&&(a.status&&(403===a.status||404===a.status))&&p.emitEvent("lessonPermissionDenied",b)})},announcePendingMorselChange:function(a){p.emitEvent("pendingMorselChange",{from:l,to:a})},changeMorsel:function(a){l=k[a];p.emitEvent("morselChange",l)},changeTidbit:function(a){p.emitEvent("tidbitChange",{tidbit:a?k[a]:null})},markMorselAsCompleted:function(a){k[a]?k[a].completed=!0:console.error("Can't find morsel #"+a+" to mark it as completed")},updateProgressForMorsel:function(a,
b){k[a]&&k[b]?k[a].progressNodeId=b:console.error("Can't find container morsel #"+a+" or perhaps progress morsel #"+b+" to update progress")},updateLastSubmissionForMorsel:function(a,b){k[a]?k[a].lastSubmission=b:console.error("Can't find morsel #"+a+"to update activity")},mergeBinCodesForMorsel:function(a,b){k[a]&&(k[a].binCodes=_.union(k[a].binCodes,b))}};return b.eventEmission(p,"pendingCourseChange courseChange pendingLessonChange lessonChange pendingMorselChange morselChange tidbitChange lessonPermissionDenied coursePermissionDenied".split(" "))}]);angular.module("viewer").factory("lessonPrefetcher",["$http","$timeout","lesson",function(a,d,b){var c=null;b.addEventListener("courseChange",function(a){c=a.lessons},{replayLast:!0});b.addEventListener("courseChange",function(){b.addEventListener("lessonChange",function(b){var f=_.find(c,function(a){return a.key===b.lesson.key}).indexInCourse;if(0<f){var g=c[f-1].key;d(function(){a.get("/api/nodes/"+g+"?depth=2&fresh=false&required_behavior=view&projection=classroom")},1E4,!1)}if(0<=f&&f<c.length-
...
d.key+"/state").success(function(a){d.lastSubmission||b.updateLastSubmissionForMorsel(d.key,a.nodestates[0]?a.nodestates[0].last_submission_data:null)}).error(function(){console.error("Failed to prefetch last submission for quiz with id "+d.key)})}});return{}}]);angular.module("viewer").factory("lessonActivityTracker",["$http","lesson","lessonContentContext","youtubeVideoPlayer","dateTime","imageQuiz","executor","mixin","$routeParams",function(a,d,b,c,e,f,g,h){function i(a){function b(a){return l(_.map(_.without([a.submission,a.evaluation],null,void 0),function(b){return{context:a.context,data:b}}),{chain:!0,timestamp:a.timestamp})}function c(){d+=1;3>d?b(a).then(function(){},c):m.emitEvent("quizActivityLogFailure",{context:a.context})}var d=0;a.evaluation&&
(a.evaluation.model="SubmissionEvaluation");b(a).then(function(){},c)}var j=null,k=null,l=function(b,c){var c=c||{},d={items:_.map(b,function(a){return{occurrence_time:c.timestamp||e.getCurrentAsUTC(),content_context:_.without(a.context,null,void 0,"none"),data:a.data}}),current_time:e.getCurrentAsUTC()},f="/api/activity";c.chain&&(f+="?related_chain=true");return a.post(f,d).then(function(a){200!==a.status&&(console.error("Error when trying to post activity. Response:"),console.error(a))})};c.addEventListener("videoPlay",
function(a){j=a},{replayLast:!0});c.addEventListener("videoPause",function(a){null!==j&&(null!==a&&void 0!==a)&&(k=a,l([{context:b.getCurrent(),data:{model:"PlayableView",start:j,stop:k}}]));j=k=null},{replayLast:!0});f.addEventListener("evaluation",i,{replayLast:!0});g.addEventListener("evaluation",i,{replayLast:!0});d.addEventListener("morselChange",function(a){if(!a.completed&&("Reading"===a.model||"EmbeddedFrame"===a.model))d.markMorselAsCompleted(a.key),l([{context:b.getCurrent(),data:{model:"CompletedExperience",
completion_context:"Student viewed the node"}}])});var m={logNodeVisit:function(a){l([{context:b.getCurrent(a),data:{model:"NodeVisit"}}])}};return h.eventEmission(m,["quizActivityLogFailure"])}]);angular.module("viewer").factory("lessonContentContext",["$routeParams","tags",function(a,d){return{getCurrent:function(b){var c=["course","lesson","exercise","morsel","tidbit"];b&&(b=_.indexOf(c,b),0<=b&&(c=c.slice(0,b+1)));return _.without(_.map(c,function(b){if(a[b+"Key"]&&"none"!==a[b+"Key"])return{tag:d[b],node_key:a[b+"Key"]}}),void 0,null)}}}]);angular.module("viewer").factory("programmingQuiz",["api","mixin","codeEditor","executor","lesson",function(a,d,b,c,e){function f(a){return _.map(a,function(a){return{name:a.name,content:a.text}})}function g(a){return _.map(a,function(a){var b={name:a.name};a._content&&"text/plain"===a._content._content_type?(b.text=a._content._plaintext,b.kind="plaintext"):a._content&&-1!==a._content._content_type.indexOf("image")&&(b.servingUrl=a._content._serving_url,b.kind="image");return b})}function h(a,b){a&&
_.each(b,function(b){var c=_.find(a.parts,function(a){return a.marker===b.name});c&&(b.text=c.content)})}var i=null,j=null,k=null,l;e.addEventListener("morselChange",function(a){l=a},{replayLast:!0});var m=null,n=null,p=null,q=null,r={init:function(c){var d=Math.round((new Date).getTime()),f=c.key;i=d;n=g(c.initial_code_files);m=g(c.initial_code_files);p=c.key;q=c;c.hasOwnProperty("lastSubmission")?(h(c.lastSubmission,m),b.loadFiles(m).then(function(){r.emitEvent("ready")})):a.get("/nodes/"+c.key+
"/state").success(function(a){if(f===l.key&&d===i){var c=a.nodestates[0],a=c?c.last_submission_data:null,c=c?c.bin_codes:[];h(a,m);e.updateLastSubmissionForMorsel(p,a);e.mergeBinCodesForMorsel(p,c);b.loadFiles(m);r.emitEvent("ready")}}).error(function(a){console.error("Error fetching programming quiz progress data");console.error(a)})},submit:function(){var a=Math.round((new Date).getTime()),d=l.key;j=a;var g={operation:"GRADE",useIframe:l.evaluator&&"IFrameEvaluator"===l.evaluator.model,iframeUrl:l.evaluator&&
l.evaluator.external_uri};r.emitEvent("submitting",{morselId:p,submissionOptions:g});c.submitFiles(f(b.getAllFiles()),p,g).then(function(b){b=b.data;if(a===j&&d===l.key){e.mergeBinCodesForMorsel(d,b.evaluation.bin_codes);if(b.evaluation.passed||0<b.evaluation.score.points_earned)e.markMorselAsCompleted(d),q.containingExercise&&e.markMorselAsCompleted(q.containingExercise.key);b.evaluation.comment&&b.evaluation.comment.indexOf("est case input")&&(r.emitEvent("run",{morselId:d,result:{stdout:b.evaluation.comment,
stderr:null,images:null}}),b.evaluation.comment=b.evaluation.feedback?b.evaluation.feedback:"Please see detailed feedback in the output area below.");r.emitEvent("evaluated",{quiz:l,result:b.evaluation})}},function(a){r.emitEvent("evaluationError",a.data)})},run:function(){var a=Math.round((new Date).getTime()),d=l.key;k=a;c.submitFiles(f(b.getAllFiles()),p,{operation:"TEST",useIframe:l.evaluator&&"IFrameEvaluator"===l.evaluator.model,iframeUrl:l.evaluator&&l.evaluator.external_uri}).then(function(b){b=
b.data;if(a===k&&d===l.key){var c={};b.execution&&b.execution._output_attachments&&(c=b.execution._output_attachments,b=g(b.execution._ordered_file_attachments),c={stdout:c.stdout?c.stdout._content._plaintext:null,stderr:c.stderr?c.stderr._content._plaintext:null,images:_.filter(b,function(a){return"image"===a.kind})});r.emitEvent("run",{morselId:d,result:c})}},function(a){r.emitEvent("runError",a.data)})},reset:function(){b.loadFiles(n)}};return d.eventEmission(r,"submitting evaluated evaluationError run runError ready".split(" "))}]);angular.module("viewer").factory("tidbits",[function(){return{isTidbitRelevant:function(a,d,b){return _.some(a.bin_code_groups,function(a){return(!b||a.bin_codes.length)&&_.every(a.bin_codes,function(a){return _.contains(d,a)})})},getTidbitViewerMode:function(a){return a?"tidbit-only":"quiz-only"}}}]);angular.module("viewer").constant("viewerPartialMap",{Video:{prefix:"video"},SketchVideo:{prefix:"video"},ProgrammingQuiz:{prefix:"programming_quiz",extension:!0},ImageFormQuiz:{prefix:"image_quiz"},Sketch:{prefix:"sketch"},EmbeddedFrame:{prefix:"iframe"},Reading:{prefix:"reading"}});angular.module("viewer").factory("viewerSettings",["mixin",function(a){var d={autoPlay:!0},b={set:function(a,e){if(d.hasOwnProperty(a)){var f=d[a];d[a]=e;b.emitEvent("change",{name:a,oldValue:f,newValue:e})}else console.error("can't set invalid setting: "+a)},get:function(a){if(d.hasOwnProperty(a))return d[a];console.error("Can't get invalid setting: "+a)}};return a.eventEmission(b,["change"])}]);angular.module("widgets").factory("github",["$q","libraryLoader","$rootScope","cookieJar",function(a,d,b,c){var e=d.loadLibraries(["base64"]),f={Accept:"application/vnd.github.raw","Content-Type":"application/json"},g={scopes:["repo"],note:"Udacity Issue Tracker",client_id:"bb427a8f7beb27b582e0",client_secret:"a014d61f827e1a761898d216ce44e23431237973"},h={scopes:["repo"],note:"Udacity Github Tracker",client_secret:"a014d61f827e1a761898d216ce44e23431237973"},i=null;(d=c.get("githubIssueTrackerToken"))&&
(i=d);var j={setToken:function(a){null===a&&c.remove("githubIssueTrackerToken");i=a},hasToken:function(){return null!==i},getAuth:function(d,g,i){var n=a.defer();e.then(function(){var a=angular.copy(f);a.Authorization="Basic "+Base64.encode(d+":"+g);i&&(a["X-GitHub-OTP"]=i);$.ajax("https://api.github.com/authorizations/clients/bb427a8f7beb27b582e0",{type:"PUT",data:JSON.stringify(h),headers:a}).done(function(a){null===a.token?j._postAuth(d,g,i).then(function(a){n.resolve(a)},function(a){n.reject(a)}):
(j.setToken(a.token),c.set("githubIssueTrackerToken",a.token),n.resolve(a))}).fail(function(a){n.reject(a)}).always(function(){b.$apply()})});return n.promise},_postAuth:function(d,h,i){var n=a.defer();e.then(function(){var a=angular.copy(f);a.Authorization="Basic "+Base64.encode(d+":"+h);i&&(a["X-GitHub-OTP"]=i);$.ajax("https://api.github.com/authorizations",{type:"POST",data:JSON.stringify(g),headers:a}).done(function(a){j.setToken(a.token);c.set("githubIssueTrackerToken",a.token);n.resolve(a)}).fail(function(a){n.reject(a)}).always(function(){b.$apply()})});
...
(e.labels=d.labels.join(","));var g=a.defer(),h=angular.copy(f);h.Authorization="token "+i;$.ajax("https://api.github.com/repos/udacity/"+c+"/issues",{headers:h,data:e,cache:!1}).done(function(a){g.resolve(a)}).fail(function(a){g.reject(a)}).always(function(){b.$apply()});return g.promise},postIssue:function(c,d){var e=a.defer(),g=angular.copy(f);g.Authorization="token "+i;$.ajax("https://api.github.com/repos/udacity/"+c+"/issues",{type:"POST",data:JSON.stringify(d),headers:g}).done(function(a){e.resolve(a)}).fail(function(a){e.reject(a)}).always(function(){b.$apply()});
return e.promise},updateIssue:function(c,d){var e=a.defer(),g=angular.copy(f);g.Authorization="token "+i;$.ajax("https://api.github.com/repos/udacity/"+c+"/issues/"+d.number,{type:"POST",data:JSON.stringify(d),headers:g}).done(function(a){e.resolve(a)}).fail(function(a){e.reject(a)}).always(function(){b.$apply()});return e.promise},getAssigneeOptions:function(c){var d=a.defer(),e=[],g=function(a){var h=angular.copy(f);h.Authorization="token "+i;$.ajax("https://api.github.com/repos/udacity/"+c+"/assignees?page="+
a+"&per_page=100",{type:"GET",headers:h}).done(function(b){e=e.concat(b);100>b.length?d.resolve(e):g(a+1)}).fail(function(a){d.reject(a)}).always(function(){b.$apply()})};g(1);return d.promise}};return j}]);angular.module("widgets").directive("staffIssues",["cacheVersion","github","lesson","lessonContentContext","$timeout","$window",function(a,d,b,c,e,f){var g=RegExp("(#### Github Issue Tracker Data Blob - DO NOT TOUCH ####)([\\s\\S]*?)(#### End of Github Issue Tracker Data Blob ####)","g");return{restrict:"A",templateUrl:"/templates/angular/staff_tools/staff_issues.html?"+a,link:function(a){a.issuePriorityOptions={p1:"OMG",p2:"HIGH",p3:"LOW"};a.labels=null;a.courseKey=null;a.showAddIssue=!1;a.currentMorselTitle=
null;var i=function(){d.getAssigneeOptions("course-issues").then(function(b){a.assigneeOptions=_.pluck(b,"login");a.assigneeOptions.unshift("")})};i();var j=function(){a.newIssue={title:"",body:"",priority:"p3"}};j();b.addEventListener("morselChange",function(b){a.labels=_.without(_.map(c.getCurrent(),function(a){return a.tag+a.node_key}),void 0,null);a.courseLabel=a.labels[0];a.lessonLabel=a.labels[1];a.morselLabel=_.last(a.labels);a.githubURLbase="https://github.com/udacity/course-issues/issues?labels=";
a.githubURL=a.githubURLbase+a.labels.join("%2C");a.currentMorselTitle=b.title;a.hasToken()&&(a.currentIssues=null,a.refreshIssues())},{replayLast:!0,removeOnDestructionOf:a});var k=function(b){b.body=b.body.replace(g,"");b.priority="p3";for(var c=[],d=0;d<b.labels.length;d++){var e=b.labels[d].name;e in a.issuePriorityOptions&&(b.priority=e);c.push(e)}b.labels=c;b.assignee=b.assignee?b.assignee.login:"";return b};a.refreshIssues=function(){d.getIssues("course-issues",{labels:[_.last(a.labels)]}).then(function(b){a.currentIssues=
_.map(b,k);a.showAddIssue=0===a.currentIssues.length?!0:!1})};a.closeIssue=function(b){confirm("Are you sure you want to close this issue?")&&(b.state="closed",a.postIssue(b))};a.addNewIssue=function(){var b={posted_from:{url:f.location.href,markdown:"["+a.currentMorselTitle+"]("+f.location.href+")"}},c=angular.copy(a.labels);c.push(a.newIssue.priority);a.newIssue.body+="\n#### Github Issue Tracker Data Blob - DO NOT TOUCH ####\n"+JSON.stringify(b,null,"\t")+"\n#### End of Github Issue Tracker Data Blob ####";
...
"text/x-ocl"],["md","markdown","text/x-markdown"],["ocl","ocl","text/x-ocl"],["r","r","text/x-rsrc"],["xml","xml",{name:"xml",htmlMode:!1}]],c=_.object(_.map(b,function(a){return[a[0],a[1]]})),e=_.object(_.map(b,function(a){return[a[1],a[2]]})),f=_.object(_.map(b,function(a){return[a[0],a[2]]}));d.getCodeMirrorSpecifierForLanguage=function(a){return e[a]};d.getCodeMirrorSpecifierForFileName=function(a){if(a)return a=_.last(a.split(".")),f[a]};d.getLanguageForFileName=function(a){if(a)return a=_.last(a.split(".")),
c[a]};var g=function(a){for(var b={},a=a.split(" "),c=0;c<a.length;++c)b[a[c]]=!0;return b},h=function(a,b){return b.startOfLine?(a.skipToEnd(),"meta"):!1};a.loadLibraries(["codemirror"]).then(function(){CodeMirror.defineMIME("text/x-cudasrc",{name:"clike",keywords:g("auto if break int case long char register continue return default short do sizeof double static else struct entry switch extern typedef float union for unsigned goto while enum void const signed volatile inline wchar_t"),builtin:g("__global__ __constant__ __shared__ threadIdx blockIdx gridDim blockDim __device__ __host__ __syncthreads"),
...
return d}]);angular.module("widgets").directive("courseCardFetcher",["cacheVersion",function(a){return{restrict:"A",scope:{cardCourses:"=",lengthOfRow:"=?",showPartners:"=?",maxImageSize:"=?",cardsPerRowOnMobile:"=?"},templateUrl:"/templates/course_card.html?"+a,controller:"courseCardFetcherHelper",link:function(a){a.setUpCards(a.cardCourses,a.lengthOfRow,a.showPartners,a.maxImageSize,a.cardsPerRowOnMobile)}}}]);angular.module("widgets").controller("courseCardFetcherHelper",["$scope","nodes","affiliates",function(a,d,b){a.partners={};var c=function(){a.finished=!0};a._calculateColumnWidth=function(a){if(!a||6<a)a=6;return Math.floor(12/a)};a._generateRows=function(b,c){var d=0;a.rows=[];var h=[];b.length<=c?a.rows=[b]:(_.each(b,function(b){d<c?(d+=1,h.push(b)):(d=1,a.rows.push(h),h=[b])}),a.rows.push(h));return a.rows};a._fetchAffiliate=function(c,d){a.partners[d]=a.partners[d]||[];_.each(c,function(c){b.get(c.key,
{projection:"image"}).then(function(b){b&&b._image_url&&a.partners[d].push({imageUrl:b._image_url,name:b.name})})})};a.fetchCards=function(b,c){return d.batchGet(b).then(function(d){return _.without(_.map(b,function(b){var e=!1,j=d[b];if(d[b]){var k=null,l=j.catalog_entry;l&&l._image&&(k=l._image.serving_url);c&&(j.affiliate_program_refs&&0<j.affiliate_program_refs.length)&&"udacity"!==j.affiliate_program_refs[0].key&&(e=!0,a._fetchAffiliate(j.affiliate_program_refs,b));return{key:b,_slug:j._slug,
servingUrl:k,title:j.title,isNanodegree:j.isNanodegree(),isCareer:j.isCareer(),getCourseType:j.getCourseType(),showPartner:e&&c}}return null}),null)})};a._setLengthOfRow=function(a,b){return!b||6<b?6>=a?a:0===a%6?6:0===a%5?5:0===a%4?4:0===a%3?3:6:b};a.setUpCards=function(b,d,g,h,i){b?(a.lengthOfRow=a._setLengthOfRow(b.length,d),a.columnWidthClass="col-xs-"+a._calculateColumnWidth(a.lengthOfRow),a.cardImageSize=[1200/a.lengthOfRow,0],angular.isArray(h)&&2===h.length?a.cardImageSize=h:angular.isNumber(h)&&
...
e);d.task=a.uploadQueue.getUniqueTask(d.uploadPath);d.task&&(d.task.notify(function(a){d.loaded=a.loaded;d.total=a.total}),b.find("input").remove(),d.task["finally"](c))}}}]);angular.module("widgets").directive("upsellBanner",["currentUser","cookieJar","nodeUtility","cacheVersion","$location","$window","safelyRedirect",function(a,d,b,c,e,f,g){return{restrict:"A",templateUrl:function(a,b){if("banner"!==b.bannerStyle){if("check"===b.bannerStyle)return"/templates/viewer/upsell_check.html?"+c;if("pad"===b.bannerStyle)return"/templates/viewer/upsell_pad.html?"+c}return"/templates/viewer/upsell_banner.html?"+c},link:function(c,i,j){c.$watch("course",function(g){if(g){var i=
_.find(a.get("_enrollments"),function(a){return a.node_key===g.key}),i=i&&b.isCurrentEnrolled(i,g),m;m="pad"===j.bannerStyle?d.exists("upsell-cancel-banner-progress"):d.exists("upsell-cancel-banner-viewer");c.showBanner=!m&&c.course.catalog_entry.paid_class&&c.course.catalog_entry.paid_class.open_for_enrollment&&!i;c.learnMore="/success#!/?courseKey="+f.encodeURIComponent(g.key)+"&start="+f.encodeURIComponent(e.absUrl())}else c.showBanner=!1});c.goToPurchase=function(a){f.location.href="/checkout#!/0?products="+
f.encodeURIComponent(_.first(a.catalog_entry.paid_class.class_product_refs).key)};c.cancelBanner=function(){d.set("upsell-cancel-banner-"+("pad"===j.bannerStyle?"progress":"viewer"),!0);c.showBanner=!1};c.goEnroll=function(){c.course&&g("/course/"+encodeURIComponent(c.course.key))}}}}]).directive("upsellHeader",["currentUser","cookieJar","nodeUtility","$location","cacheVersion","nodes","products","$window",function(a,d,b,c,e,f,g,h){return{restrict:"A",templateUrl:"/templates/upsell_header.html?"+
